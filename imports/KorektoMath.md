...
### Infinitessimals
```korekto
𝓍 ≠ 0;⎨𝜀 < ⎨𝓍	#M88 Infinitessimal: 𝜀
𝜀 ≠ 0	#P89 1st order 𝜀
𝜀² = 0	#P90 Vanishing 𝜀
𝜹𝓐(𝒶) = 𝓐(𝒶+𝜀)-𝓐(𝒶)	#A91 Differential: 𝜹
𝓓𝓐(𝒶) = 𝜹𝓐(𝒶)/𝜀	#A92 Derivative: 𝓓
```
## Grouping

### Token grouping
```korekto
S1𝟭S2;S1(𝟭)S2	#M93 a → (a)
S1(𝟭)S2;S1𝟭S2	#M94 (a) → a
# And the above repeated up-to 3 times:
S1𝟭S2𝟮S3;S1(𝟭)S2(𝟮)S3	#M95 a~b → (a)~(b)
S1(𝟭)S2(𝟮)S3;S1𝟭S2𝟮S3	#M96 (a)~(b) → a~b
S1𝟭S2𝟮S3𝟯S4;S1(𝟭)S2(𝟮)S3(𝟯)S4	#M97 a~b~c → (a)~(b)~(c)
S1(𝟭)S2(𝟮)S3(𝟯)S4;S1𝟭S2𝟮S3𝟯S4	#M98 (a)~(b)~(c) → a~b~c
```
### Binary spacing
```korekto
S1(𝟭 ♦ 𝟮)S2;S1(𝟭♦𝟮)S2	#M99 (a_+_b) → (a+b)
S1(𝟭♦𝟮)S2;S1(𝟭 ♦ 𝟮)S2	#M100 (a+b) → (a_+_b)
S1♮(𝟭♭♦♭𝟮);S1 𝟭♦𝟮	#M101 ♭(a♭+♭b)$ → _a+b$
S1 𝟭♦𝟮;S1♮(𝟭♭♦♭𝟮)	#M102 _a+b$ → ♭(a♭+♭b)$
(𝟭♭♦♭𝟮)♮S1;𝟭♦𝟮 S1	#M103 ^(a♭+♭b)♭ → ^a+b_
𝟭♦𝟮 S1;(𝟭♭♦♭𝟮)♮S1	#M104 ^a+b_ → ^(a♭+♭b)♭
S1 𝟭♦𝟮 S2;S1♮(𝟭♭♦♭𝟮)♮S2	#M105 _a+b_ → ♭(a♭+♭b)♭
S1♮(𝟭♭♦♭𝟮)♮S2;S1 𝟭♦𝟮 S2	#M106 ♭(a♭+♭b)♭ → _a+b_
```
### MultDiv spacing
```korekto
# MultDiv has higher precedence than AddSub
S1 𝟭♚𝟮;S1 𝟭 ♚ 𝟮	#M107 _a*b$ → _a_*_b$
S1 𝟭 ♚ 𝟮;S1 𝟭♚𝟮	#M108 _a_*_b$ → _a*b$
𝟭♚𝟮 S2;𝟭 ♚ 𝟮 S2	#M109 ^a*b_ → ^a_*_b_
𝟭 ♚ 𝟮 S2;𝟭♚𝟮 S2	#M110 ^a_*_b_ → ^a*b_
S1 𝟭 ♚ 𝟮 S2;S1 𝟭♚𝟮 S2	#M111 _a_*_b_ → _a*b_
S1 𝟭♚𝟮 S2;S1 𝟭 ♚ 𝟮 S2	#M112 _a*b_ → _a_*_b_
```
### MutlDiv Grouping
```korekto
# MultDiv has higher precedence than AddSub
...
### GroupGlob grouping
```korekto
S1♭(g1)♭S2;S1 g1 S2	#M125 ♭(a)♭ → _a_
S1 g1 S2;S1♭(g1)♭S2	#M126 _a_ → ♭(a)♭
S1♭(g1);S1 g1	#M127 ♭(a)$ → _a$
S1 g1;S1♭(g1)	#M128 _a$ → ♭(a)$
(g1)♭S1;g1 S1	#M129 ^(a)♭ → ^a_
g1 S1;(g1)♭S1	#M130 ^a_ → ^(a)♭
```
### Group grouping
```korekto
S1 ⚍ (G1) ⚎ S2;S1 ⚍ G1 ⚎ S2	#M131 +_(a)_+ → +_a_+
S1 ⚍ G1 ⚎ S2;S1 ⚍ (G1) ⚎ S2	#M132 +_a_+ → +_(a)_+
S1 ⚍ G1 ⚎ G2 ⚏ S2;S1 ⚍ (G1) ⚎ (G2) ⚏ S2	#M133 →+_(a)_+_(b)_+
S1 ⚍ (G1) ⚎ (G2) ⚏ S2;S1 ⚍ G1 ⚎ G2 ⚏ S2	#M134 →+_a_+_b_+
S1 ⚍ (G1);S1 ⚍ G1	#M135 +_(a)$ → +_a$
S1 ⚍ G1;S1 ⚍ (G1)	#M136 +_a$ → +_(a)$
(G1) ⚍ S1;G1 ⚍ S1	#M137 ^(a)_+ → ^a_+
G1 ⚍ S1;(G1) ⚍ S1	#M138 ^a_+ → ^(a)_+
# Rare cases ((a))
S1 ⚍ G1⦆S2;S1 ⚍ (G1)⦆S2	#M139 +_a)~ → +_(a))~
S1 ⚍ (G1)⦆S2;S1 ⚍ G1⦆S2	#M140 +_(a))~ → +_a)~
S1⦅G1 ⚍ S2;⦅(G1) ⚍ S2	#M141 ~(a_+ → ~((a)_+
S1⦅(G1) ⚍ S2;⦅G1 ⚍ S2	#M142 ~((a)_+ → ~(a_+
# Rare cases a+b+c
S1 ⚍ g1±g2;S1 ⚍ g1 ± g2	#M143 +_a+b$ → +_a_+_b$
g1±g2 ⚍ S2;g1 ± g2 ⚍ S2	#M144 ^a+b_+ → ^a_+_b_+
S1 ⚎ g1±g2 ⚍ S2;S1 ⚎ g1 ± g2 ⚍ S2	#M145 +_a+b_+ → +_a_+_b_+
```
### Tight grouping
```korekto
S1(𝟭♩𝟮)⚑S2;S1𝟭♩𝟮S2	#M146 (a^b) → a^b
S1(𝟭♩𝟮)⚑S2(𝟯♪𝟰)⚑S3;S1𝟭♩𝟮S2𝟯♪𝟰S3	#M147 (a^b)~(c^d) → a^b~c^c
S1𝟭♩𝟮⚑S2;S1(𝟭♩𝟮)S2	#M148 a^b → (a^b)
S1𝟭♩𝟮⚑S2𝟯♪𝟰⚑S3;S1(𝟭♩𝟮)S2(𝟯♪𝟰)S3	#M149 a^b~c^d → (a^b)~(c^c)
```
## Algebra

### Implied/Explicit multiplication
```korekto
S1𝟭♭𝟮S2;S1𝟭♮*♮𝟮S2	#M150 Explicit*
S1𝟭♮*♮𝟮S2;S1𝟭♭𝟮S2	#M151 Implied*
```
### Equality
```korekto
N1 ⚌ N2;N2 = N1	#M152 Symmetry
N1 = N1	#A153 Reflection
```
### Transitive
```korekto
N1 ⚌ N2;N2 ⚌ N3;N1 = N3	#I154 a=b;b=c;a=c
N1 ⚌ N2;N2 ⚌ N3;N3 = N1	#I155 a=b;b=c;c=a
N1 ⚌ N2;N3 ⚌ N2;N1 = N3	#I156 a=b;c=b;a=c
N1 ⚌ N2;N3 ⚌ N2;N3 = N1	#I157 a=b;c=b;c=a
```
### One
```korekto
# (a/a)
S1(𝟭♭/♭𝟭)S2;S1(1)S2	#M158 (a/a)→(1)
S1(g1 / g1)S2;S1(1)S2	#M159 (a / a)→(1)
# *One*
S1♭*♭1 S2;S1 S2	#M160 *1_
S1 1♭*♭S2;S1 S2	#M161 _1*
S1♭*♭(1) S2;S1 S2	#M162 *(1)_
S1 (1)♭*♭S2;S1 S2	#M163 _(1)*
...
### Zero
```korekto
S1(𝟭♭-♭𝟭)S2;S1(0)S2	#M168 (a-a)→(0)
S1♭+♭𝟭♭-♭𝟭♭±♭S2;S1♭±♭S2	#M169 +a-a± → ±
S1+𝟭-𝟭 S2;S1 S2	#M170 +a-a_
S1♭⚀♭0♭±♭S2;S1♭±♭S2	#M171 ±0± → ±
```
### (a/b)
```korekto
S1 𝟭♭/♭𝟮;S1 𝟯*𝟭 / 𝟯*𝟮	#M172 _x*a_/_x*b$
S1(𝟭♭/♭𝟮)S2;S1(𝟯*𝟭 / 𝟯*𝟮)S2	#M173 (x*a_/_x*b)
S1(g1 / g2)S2;S1(𝟭*(g1) / 𝟭*(g2))S2	#M174 (x*(a)_/_x*(b))
S1𝟭*(1♭/♭𝟮)⚑S2;S1(𝟭♮/♮𝟮)S2	#M175 x*(1/y) → (x/y)
S1𝟭*(1 / g1)⚑S2;S1(𝟭 / g1)S2	#M176 x*(1_/_y) → (x_/_y)
S1 1♭±♭(𝟭 / g2)⚑S2;S1 (g2±𝟭 / g2)S2	#M177 _1±(a_/_b) → (b±a / b)
```
### Distribute
```korekto
S1𝟭*(𝟮♭±♭𝟯)⚑S2;S1(𝟭*𝟮♮±♮𝟭*𝟯)S2	#M178 (x*a♭±♭x*b)
S1𝟭*(g2 ± g3)⚑S2;S1(𝟭*(g2)♭±♭𝟭*(g3))S2	#M179 (x*(a)♭±♭x*(b))
```
### Substitution
```korekto
𝟭 ⚌ 𝟮;S1𝟭S2;S1𝟮S2	#I180 a=b,a→b
𝟭 ⚌ N2;S1𝟭S2;S1(N2)S2	#I181 a=(b),a→(b)
N1 ⚌ 𝟭;S1♭(N1)♮S2;S1♭𝟭♮S2	#I182 (a)=b,(a)→b
N1 ⚌ 𝟭;S1♭(N1)♭S2♭(N1)♭S3;S1♭𝟭♭S2♭𝟭♭S3	#I183 (a)=b,(a)→b~b
N1 ⚌ 𝟭;S1𝟭S2;S1(N1)S2	#I184 (a)=b;b→(a)
N1 ⚌ N2;S1(N1)S2;S1(N2)S2	#I185 (a)=(b),(a)→(b)
N1 ⚌ N2;S1(N2)S2;S1(N1)S2	#I186 (a)=(b),(b)→(a)
N1 ⚌ N2;N1 ⚍ S1;N2 ⚍ S1	#I187 a=b, ^a_+ → ^b_+
N1 ⚌ N2;N2 ⚍ S1;N1 ⚍ S1	#I188 a=b, ^b_+ → ^a_+
N1 ⚌ N2;S1 ⚍ N1;S1 ⚍ N2	#I189 a=b, +_a$ → +_b$
N1 ⚌ N2;S1 ⚍ N2;S1 ⚍ N1	#I190 a=b, +_b$ → +_a$
```
### Adding
```korekto
S1(𝟭 + -𝟮)S2;S1(𝟭♮-♮𝟮)S2	#M191 a+-b=a-b
S1(𝟭♭-♭𝟮)S2;S1(𝟭 + -𝟮)S2	#M192 a-b=a+-b
S1⚑𝟭∧𝟮*𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M193 a^b*a^c=a^(b+c)
S1⚑𝟭∧𝟮𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M194 a^ba^c=a^(b+c)
S1⚑𝟭∧(𝟮♭+♭𝟯)⚑S2;S1𝟭∧𝟮*𝓊𝟭∧𝟯S2	#M195 a^(b+c)=a^b*a^c
S1(𝟭♭+♭𝟮)S2;S1(𝟮♮+♮𝟭)S2	#M196 (a+b)→(b+a)
```
### Subtracting
```korekto
S1♭--𝟭♮S2;S1♭𝟭♮S2	#M197 --a→a
```
## Calculus
```korekto
# Derivatives
# Constant Rule
𝓓ᵢ𝖆 = 0	#A198 Constant rule
# Power Rule
𝓓ᵢ(𝓍∧𝖆) = 𝒹*𝓍∧(𝖆-1)	#A199 Power rule
# Sum and Difference Rules
𝓓ᵢ(𝓍 + 𝓎) = 𝓓ᵢ𝓍 + 𝓓ᵢ𝓎	#A200 Sum rule
# Product Rule
𝓓ᵢ(𝓍*𝓎) = 𝓓ᵢ𝓍*𝓎 + 𝓍*𝓓ᵢ𝓎	#A201 Product rule
# Quotient Rule
𝓓ᵢ(𝓍 / 𝓎) = (𝓓ᵢ(𝓍)𝓎 - 𝓍𝓓ᵢ(𝓎)) / 𝓎²	#A202 Quotient rule
𝓓ᵢ(1 / 1+𝓍) = -𝓓ᵢ𝓍 / (1+𝓍)²	#A203 From quotient rule
# Chain Rule
# This one is meta.  :-??
𝓓ᵢ𝓐𝓑𝓍 = (𝓓𝓐)𝓑𝓍*(𝓓𝓑)𝓍*𝓓ᵢ𝓍	#A204 Chain rule
# Exponential
𝓓ᵢ(𝖆∧𝓍) = ⌊𝖆𝓓ᵢ(𝓍)𝖆∧𝓍	#A205 D(a^x)=log(a)D(x)a^x
𝓓ᵢ(𝖊∧𝓍) = 𝓓ᵢ(𝓍)𝖊∧𝓍	#A206 D(e^x)=D(x)e^x
```
