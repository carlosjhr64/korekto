...
(𝓍 ♚ g1)♭⚑S2;𝓍♚(g1) S2	#M128 ^(a_*_g)♭ → ^a*(g)_
𝓍♚(g1) S2;(𝓍 ♚ g1)♭S2	#M129 ^a*(g)_ → ^(a_*_g)♭
S1♦(𝓍𝓎)♥S2;S1♦𝓍𝓎♥S2 #M130 *(ab)* → *ab*
S1♦𝓍𝓎♥S2;S1♦(𝓍𝓎)♥S2	#M131 *ab* → *(ab)*
S1♦(𝓍𝓎);S1♦𝓍𝓎	#M132 *(ab)$ → *ab$
S1♦𝓍𝓎;S1♦(𝓍𝓎)	#M133 *ab$ → *(ab)$
(𝓍𝓎)♦S2;𝓍𝓎♦S2	#M134 ^(ab)* → ^ab*
𝓍𝓎♦S2;(𝓍𝓎)♦S2	#M135 ^ab* → ^(ab)*
```
### GroupGlob grouping
```korekto
S1♭(g1)♭S2;S1 g1 S2	#M136 ♭(g)♭ → _g_
S1 g1 S2;S1♭(g1)♭S2	#M137 _g_ → ♭(g)♭
S1♭(g1);S1 g1	#M138 ♭(g)$ → _g$
S1 g1;S1♭(g1)	#M139 _g$ → ♭(g)$
(g1)♭S1;g1 S1	#M140 ^(g)♭ → ^g_
g1 S1;(g1)♭S1	#M141 ^g_ → ^(g)♭
# Nested groupings
S1 g1⦆S2;S1 (g1)⦆S2	#M142 _g)→_(g))
S1⦅g1 S2;S1⦅(g1) S2	#M143 (g_→((g)_
```
### Group grouping
```korekto
S1 ⚍ (G1) ⚎ S2;S1 ⚍ G1 ⚎ S2	#M144 +_(G)_+ → +_G_+
S1 ⚍ G1 ⚎ S2;S1 ⚍ (G1) ⚎ S2	#M145 +_G_+ → +_(G)_+
S1 ⚍ G1 ⚎ G2 ⚏ S2;S1 ⚍ (G1) ⚎ (G2) ⚏ S2	#M146 →+_(G)_+_(F)_+
S1 ⚍ (G1) ⚎ (G2) ⚏ S2;S1 ⚍ G1 ⚎ G2 ⚏ S2	#M147 →+_G_+_F_+
S1 ⚍ (G1);S1 ⚍ G1	#M148 +_(G)$ → +_G$
S1 ⚍ G1;S1 ⚍ (G1)	#M149 +_G$ → +_(G)$
(G1) ⚍ S1;G1 ⚍ S1	#M150 ^(G)_+ → ^G_+
G1 ⚍ S1;(G1) ⚍ S1	#M151 ^G_+ → ^(G)_+
# Rare cases ((G))
S1 ⚍ G1⦆S2;S1 ⚍ (G1)⦆S2	#M152 +_G)~ → +_(G))~
S1 ⚍ (G1)⦆S2;S1 ⚍ G1⦆S2	#M153 +_(G))~ → +_G)~
S1⦅G1 ⚍ S2;⦅(G1) ⚍ S2	#M154 ~(G_+ → ~((G)_+
S1⦅(G1) ⚍ S2;⦅G1 ⚍ S2	#M155 ~((G)_+ → ~(G_+
# Rare cases g+f+h
S1 ⚍ g1±g2;S1 ⚍ g1 ± g2	#M156 +_g+f$ → +_g_+_f$
g1±g2 ⚍ S2;g1 ± g2 ⚍ S2	#M157 ^g+f_+ → ^g_+_f_+
S1 ⚎ g1±g2 ⚍ S2;S1 ⚎ g1 ± g2 ⚍ S2	#M158 +_g+f_+ → +_g_+_f_+
```
### Tight grouping
```korekto
S1(𝟭♩𝟮)⚑S2;S1𝟭♩𝟮S2	#M159 (a^b) → a^b
S1𝟭♩𝟮⚑S2;S1(𝟭♩𝟮)S2	#M160 a^b → (a^b)
S1(𝟭♩𝟮)⚑S2(𝟯♪𝟰)⚑S3;S1𝟭♩𝟮S2𝟯♪𝟰S3	#M161 (a^b)~(c^d) → a^b~c^c
S1𝟭♩𝟮⚑S2𝟯♪𝟰⚑S3;S1(𝟭♩𝟮)S2(𝟯♪𝟰)S3	#M162 a^b~c^d → (a^b)~(c^c)
```
## Algebra

### Implied/Explicit multiplication
```korekto
S1𝟭♭𝟮S2;S1𝟭♮*♮𝟮S2	#M163 Explicit*
S1𝟭♮*♮𝟮S2;S1𝟭♭𝟮S2	#M164 Implied*
```
### Equality
```korekto
N1 ⚌ N2;N2 = N1	#M165 Symmetry
N1 = N1	#A166 Reflection
```
### Transitive
```korekto
N1 ⚌ N2;N2 ⚌ N3;N1 = N3	#I167 a=b;b=c;a=c
N1 ⚌ N2;N2 ⚌ N3;N3 = N1	#I168 a=b;b=c;c=a
N1 ⚌ N2;N3 ⚌ N2;N1 = N3	#I169 a=b;c=b;a=c
N1 ⚌ N2;N3 ⚌ N2;N3 = N1	#I170 a=b;c=b;c=a
```
### One
```korekto
# (a/a) 𝓇 𝓈
𝓇(𝟭♭/♭𝟭)𝓈;𝓇1𝓈	#M171 (a/a)→1
𝓇(g1 / g1)𝓈;𝓇1𝓈	#M172 (g / g)→1
# *One*
S1♭*♭1 S2;S1 S2	#M173 *1_
S1 ⚬1♭*♭S2;S1 ⚬S2	#M174 _1*
```
### Zero
```korekto
𝓇(𝟭♭-♭𝟭)𝓈;𝓇0𝓈	#M175 (a-a)→0
S1♭+♭𝟭♭-♭𝟭♭±♭S2;S1♭±♭S2	#M176 +a-a± → ±
S1♭-♭𝟭♭+♭𝟭♭±♭S2;S1♭±♭S2	#M177 -a+a± → ±
S1♭+♭𝟭♭-♭𝟭;S1	#M178 +a-a$ → $
S1♭-♭𝟭♭+♭𝟭;S1	#M179 -a+a$ → $
S1+𝟭-𝟭 S2;S1 S2	#M180 +a-a_
S1-𝟭+𝟭 S2;S1 S2	#M181 -a+a_
S1 𝟭+𝟭-S2;S1 S2	#M182 _a+a-
S1 𝟭-𝟭+S2;S1 S2	#M183 _a-a+
# Order here matters. This one is tested first:
S1♭⚀♭0♭⚀♭S2;S1♭+♭S2	#M184 ±0± → +
# This one is tested after the above:
S1♭±♭0♭⚀♭S2;S1♭-♭S2	#M185 ±0+ → -
```
### (a/b)
```korekto
S1 𝟭♭/♭𝟮;S1 𝟯*𝟭 / 𝟯*𝟮	#M186 _x*a_/_x*b$
S1 𝟭♭/♭𝟮 S2;S1 𝟯*𝟭 / 𝟯*𝟮 S2	#M187 _x*a_/_x*b_
𝟭♭/♭𝟮 S2;𝟯*𝟭 / 𝟯*𝟮 S2	#M188 ^x*a_/_x*b_
S1(𝟭♭/♭𝟮)S2;S1(𝟯*𝟭 / 𝟯*𝟮)S2	#M189 (x*a_/_x*b)
S1(g1 / g2)S2;S1(𝟭*(g1) / 𝟭*(g2))S2	#M190 (x*(g)_/_x*(f))
S1𝟭*(1♭/♭𝟮)⚑S2;S1(𝟭♮/♮𝟮)S2	#M191 x*(1/y) → (x/y)
S1𝟭*(1 / g1)⚑S2;S1(𝟭 / g1)S2	#M192 x*(1_/_g) → (x_/_g)
S1 1♭±♭(𝟭 / g2)⚑S2;S1 (g2±𝟭 / g2)S2	#M193 _1±(a_/_g) → (g±a / g)
S1 𝓍/𝓎²;S1 𝓍/𝓎 1/𝓎	#M194 _a/b²$→_a/b_1/b$
𝓍/𝓎² S2;𝓍/𝓎 1/𝓎 S2	#M195 ^a/b²_→^a/b_1/b$_
S1 𝓍/𝓎² S2;S2 𝓍/𝓎 1/𝓎 S2	#M196 _a/b²_→_a/b_1/b$_
```
### Distribute
```korekto
S1𝟭*(𝟮♭±♭𝟯)⚑S2;S1(𝟭*𝟮♮±♮𝟭*𝟯)S2	#M197 (x*a♭±♭x*b)
S1𝟭*(g2 ± g3)⚑S2;S1(𝟭*(g2)♭±♭𝟭*(g3))S2	#M198 (x*(g)♭±♭x*(f))
```
### Substitution
```korekto
𝟭 ⚌ 𝟮;S1𝟭S2;S1𝟮S2	#I199 a=b,a→b
𝟭 ⚌ 𝟮;S1𝟭S2𝟭S3;S1𝟮S2𝟮S3	#I200 a=b,2*a→b
𝟭 ⚌ 𝟮;S1𝟭S2𝟭S3𝟭S4;S1𝟮S2𝟮S3𝟮S4	#I201 a=b,3*a→b
𝟭 ⚌ g1;S1 g1⦆S2;S1 𝟭⦆S2	#I202 a=g,_g)→_a)
g1 ⚌ 𝟭;S1 g1⦆S2;S1 𝟭⦆S2	#I203 g=a,_g)→_a)
𝟭 ⚌ g1;S1⦅g1 S2;S1⦅𝟭 S2	#I204 a=g,(g_→(a_
g1 ⚌ 𝟭;S1⦅g1 S2;S1⦅𝟭 S2	#I205 g=a,(g_→(a_
g1 ⚌ g2;S1 g1 S2;S1 g2 S2	#I206 g=f,_g_→_f_
g1 ⚌ g2;S1 g2 S2;S1 g1 S2	#I207 g=f,_f_→_g_
g1 ⚌ g2;S1 g1;S1 g2	#I208 g=f,_g$→_f$
g1 ⚌ g2;S1 g2;S1 g1	#I209 g=f,_f$→_g$
g1 ⚌ g2;g1 S2;g2 S2	#I210 g=f,^g_→^f_
g1 ⚌ g2;g2 S2;g1 S2	#I211 g=f,^f_→^g_
𝟭 ⚌ N1;S1𝟭S2;S1(N1)S2	#I212 a=G,a→(G)
N1 ⚌ 𝟭;S1𝟭S2;S1(N1)S2	#I213 G=a,a→(G)
# The above twice below
N1 ⚌ 𝟭;S1(N1)S2(N1)S3;S1𝟭S2𝟭S3	#I214 G=a,(G)→a~a
𝟭 ⚌ N1;S1(N1)S2;S1𝟭S2	#I215 a=G,(G)→a
N1 ⚌ 𝟭;S1(N1)S2;S1𝟭S2	#I216 G=a,(G)→a
N1 ⚌ N2;S1(N1)S2;S1(N2)S2	#I217 G=F,(G)→(F)
N1 ⚌ N2;S1(N2)S2;S1(N1)S2	#I218 G=F,(F)→(G)
N1 ⚌ N2;N1 ⚍ S1;N2 ⚍ S1	#I219 G=F, ^G_+ → ^F_+
N1 ⚌ N2;N2 ⚍ S1;N1 ⚍ S1	#I220 G=F, ^F_+ → ^G_+
N1 ⚌ N2;S1 ⚍ N1;S1 ⚍ N2	#I221 G=F, +_G$ → +_F$
N1 ⚌ N2;S1 ⚍ N2;S1 ⚍ N1	#I222 G=F, +_F$ → +_G$
N1 ⚌ N2;S1 ⚍ N1 ⚎ S2;S1 ⚍ N2 ⚎ S2	#I223 G=F, +_G_+ → +_F_+
N1 ⚌ N2;S1 ⚍ N2 ⚎ S2;S1 ⚍ N1 ⚎ S2	#I224 G=F, +_F_+ → +_G_+
```
### Adding
```korekto
S1(𝟭 + -𝟮)S2;S1(𝟭♮-♮𝟮)S2	#M225 a+-b=a-b
S1(𝟭♭-♭𝟮)S2;S1(𝟭 + -𝟮)S2	#M226 a-b=a+-b
S1⚐𝟭∧𝟮*𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M227 a^b*a^c=a^(b+c)
S1⚐𝟭∧𝟮𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M228 a^ba^c=a^(b+c)
S1⚐𝟭∧(𝟮♭+♭𝟯)⚑S2;S1𝟭∧𝟮*𝟭∧𝟯S2	#M229 a^(b+c)=a^b*a^c
S1(𝟭♭+♭𝟮)S2;S1(𝟮♮+♮𝟭)S2	#M230 (a+b)→(b+a)
```
### Subtracting
```korekto
S1♭--𝟭♮S2;S1♭𝟭♮S2	#M231 --a→a
𝓍 = -𝓎;-𝓍 = 𝓎	#M232 a=-b;-a=-b
```
### Balancing
```korekto
𝓍 = 𝓊 g1;𝓐𝓍 = 𝓐𝓊 g1	#M233 x_=_G_g;Fx_=_FG_g
```
## Functions
```korekto
# Natural log
⌊ 𝓍/𝓎 = ⌊𝓍 - ⌊𝓎	#A234 ⌊(a/b)=⌊a-⌊b
# Squash
⌈𝓍 = 1 / 1+⌉-𝓍	#A235 Squash: ⌈
# Unsquash
⌋𝓍 = ⌊ 𝓍/(1-𝓍)	#A236 Unsquash: ⌋
# Binary balance
# 𝓑 is being used as a pattern key, so I temporarily replace it:
! replace! 𝓑 TMP
# Now I can define 𝓑 in an axiom:
𝓑𝓍 = (1-𝓍)*𝓍	#A237 Binary balance: 𝓑
! replace! TMP 𝓑
```
## Calculus
```korekto
# Derivatives
# Constant Rule
𝓓ᵢ𝖆 = 0	#A238 Constant rule
# Power Rule
𝓓ᵢ(𝓍∧𝖆) = 𝒹*𝓍∧(𝖆-1)	#A239 Power rule
# Sum and Difference Rules
𝓓ᵢ(𝓍 + 𝓎) = 𝓓ᵢ𝓍 + 𝓓ᵢ𝓎	#A240 Sum rule
# Product Rule
𝓓ᵢ(𝓍*𝓎) = 𝓓ᵢ𝓍*𝓎 + 𝓍*𝓓ᵢ𝓎	#A241 Product rule
# Quotient Rule
𝓓ᵢ(𝓍 / 𝓎) = (𝓓ᵢ(𝓍)𝓎 - 𝓍𝓓ᵢ(𝓎)) / 𝓎²	#A242 Quotient rule
𝓓ᵢ(1 / 1+𝓍) = -𝓓ᵢ𝓍 / (1+𝓍)²	#A243 From quotient rule
# Chain Rule
# This one is meta.  :-??
𝓓ᵢ𝓐𝓑𝓍 = (𝓓𝓐)𝓑𝓍*(𝓓𝓑)𝓍*𝓓ᵢ𝓍	#A244 Chain rule
# Exponential
𝓓ᵢ(𝖆∧𝓍) = ⌊𝖆𝓓ᵢ(𝓍)𝖆∧𝓍	#A245 D(a^x)=log(a)D(x)a^x
𝓓ᵢ(𝖊∧𝓍) = 𝓓ᵢ(𝓍)𝖊∧𝓍	#A246 D(e^x)=D(x)e^x
# Computations:
𝓓ᵢ(-𝓍) = -𝓓ᵢ(𝓍)	#A247 𝓓ₓ(-𝑦)=-𝓓(𝑦)
ᵢ → 𝑎;𝓓ᵢ𝑎 = 1	#M248 𝓓ₓ𝑥=1
ᵢ → 𝑎;𝓓ᵢ(-𝑎) = -1	#M249 𝓓ₓ-𝑥=-1
```
## Einstein notation
```korekto
ᵢ⭎ = ⁱ;∑ᵢ(𝓍ᵢ𝓎ᵢ) = 𝓍ⁱ𝓎ᵢ	#M250 Einstein notation
# ₕ₊ = ᵢ
# ᵢ⭎ = ⁱ
# 𝒂ₕ = ⌈ 𝒃ₕ+𝑾ₕⁱ𝒂ᵢ
# 𝒂ₕ = ⌈ 𝒃ₕ+𝑾ₕⁱ𝒂ₕ₊
