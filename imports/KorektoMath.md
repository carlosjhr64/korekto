...
S1 𝟭♚𝟮 S2;S1 𝟭 ♚ 𝟮 S2	#M110 ~a*b~->~a * b~
```
### MutlDiv Grouping
```korekto
# MultDiv has higher precedence than AddSub
...
### GroupGlob grouping
```korekto
S1♭(g1)♭S2;S1 g1 S2	#M118 Space
S1 g1 S2;S1♭(g1)♭S2	#M119 Group
...
### Group grouping
```korekto
S1 ⚍ (G1) ⚎ S2;S1 ⚍ G1 ⚎ S2	#M124 +Space+
S1 ⚍ G1 ⚎ S2;S1 ⚍ (G1) ⚎ S2	#M125 +Group+
S1 ⚍ G1 ⚎ G2 ⚏ S2;S1 ⚍ (G1) ⚎ (G2) ⚏ S2	#M126 +Group+Group+
S1 ⚍ (G1);S1 ⚍ G1	#M127 +Space
S1 ⚍ G1;S1 ⚍ (G1)	#M128 +Group
(G1) ⚍ S1;G1 ⚍ S1	#M129 Space+
G1 ⚍ S1;(G1) ⚍ S1	#M130 Group+
S1 ⚍ G1⦆;S1 ⚍ (G1)⦆	#M131 +Group)
S1 ⚍ g1±g2;S1 ⚍ g1 ± g2	#M132 Space ~a+b
```
### Tight grouping
```korekto
S1(𝟭♩𝟮)S2;S1𝟭♩𝟮S2	#M133 Tight un-grouped
S1𝟭♩𝟮S2;S1(𝟭♩𝟮)S2	#M134 Tight grouped
```
## Algebra

### Implied/Explicit multiplication
```korekto
S1𝟭♭𝟮S2;S1𝟭♮*♮𝟮S2	#M135 Explicit*
S1𝟭♮*♮𝟮S2;S1𝟭♭𝟮S2	#M136 Implied*
```
...
```korekto
# (a/a)
S1(𝟭♭/♭𝟭)S2;S1(1)S2	#M141 (a/a)=>(1)
S1(g1 / g1)S2;S1(1)S2	#M142 (a / a)=>(1)
# One
...
### Zero
```korekto
S1(𝟭♭-♭𝟭)S2;S1(0)S2	#M151 (a-a)=>(0)
S1♭⚀♭𝟭♭-♭𝟭♭±♭S2;S1♭±♭S2	#M152 ±a-a±=>±
S1⚀𝟭-𝟭 S2;S1 S2	#M153 +a-a~
S1♭⚀♭0♭±♭S2;S1♭±♭S2	#M154 ±0±=>±
```
### (a/b)
```korekto
S1 𝟭♭/♭𝟮;S1 𝟯*𝟭 / 𝟯*𝟮	#M155 x*a / x*b$
S1(𝟭♭/♭𝟮)S2;S1(𝟯*𝟭 / 𝟯*𝟮)S2	#M156 (xa / xb)
S1(g1 / g2)S2;S1(𝟭*(g1) / 𝟭*(g2))S2	#M157 (x(a) / x(b))
S1𝟭*(1♭/♭𝟮)⚑S2;S1(𝟭♮/♮𝟮)S2	#M158 (x*1)/(y)
S1𝟭*(1 / g1)⚑S2;S1(𝟭 / g1)S2	#M159 x*1 /  y
S1 1♭±♭(𝟭 / g2)⚑S2;S1 (g2±𝟭 / g2)S2	#M160 ~1+(a/b)->~(b+a / b)
```
### Distribute
```korekto
S1𝟭*(𝟮♭±♭𝟯)⚑S2;S1(𝟭*𝟮♮±♮𝟭*𝟯)S2	#M161 (xa±xb)
S1𝟭*(g2 ± g3)⚑S2;S1(𝟭*(g2) ± 𝟭*(g3))S2	#M162 (x(a) ± x(b))
```
### Substitution
```korekto
𝟭 = 𝟮;S1𝟭S2;S1𝟮S2	#I163 a=b;a->b
𝟭 = N2;S1𝟭S2;S1(N2)S2	#I164 a=b;a->(b)
N1 = 𝟭;S1♭(N1)♮S2;S1♭𝟭♮S2	#I165 (a)=b;(a)->b
N1 = 𝟭;S1♭(N1)♭S2♭(N1)♭S3;S1♭𝟭♭S2♭𝟭♭S3	#I166 (a)=b;(a)->b,b
N1 = 𝟭;S1𝟭S2;S1(N1)S2	#I167 (a)=b;b->(a)
N1 = N2;S1(N1)S2;S1(N2)S2	#I168 a=b;(a)->(b)
N1 = N2;S1(N2)S2;S1(N1)S2	#I169 a=b;(b)->(a)
N1 = N2;N1 ⚍ S1;N2 ⚍ S1	#I170 a=b;a->b+
N1 = N2;N2 ⚍ S1;N1 ⚍ S1	#I171 a=b;b->a+
N1 = N2;S1 ⚍ N1;S1 ⚍ N2	#I172 a=b;a->+b
N1 = N2;S1 ⚍ N2;S1 ⚍ N1	#I173 a=b;b->+a
```
### Adding
```korekto
S1(𝟭 + -𝟮)S2;S1(𝟭♮-♮𝟮)S2	#M174 a+-b=a-b
S1(𝟭♭-♭𝟮)S2;S1(𝟭 + -𝟮)S2	#M175 a-b=a+-b
S1⚑𝟭∧𝟮*𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M176 a^b*a^c=a^(b+c)
S1⚑𝟭∧𝟮𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M177 a^ba^c=a^(b+c)
S1⚑𝟭∧(𝟮♭+♭𝟯)⚑S2;S1𝟭∧𝟮*𝓊𝟭∧𝟯S2	#M178 a^(b+c)=a^b*a^c
S1(𝟭♭+♭𝟮)S2;S1(𝟮♮+♮𝟭)S2	#M179 (a+b)->(b+a)
```
### Subtracting
```korekto
S1♭--𝟭♮S2;S1♭𝟭♮S2	#M180 --a->a
```
## Calculus
```korekto
# Derivatives
# Constant Rule
𝓓ᵢ𝒹 = 0	#A181 Constant rule
# Power Rule
𝓓ᵢ(𝓍∧𝒹) = 𝒹*𝓍∧(𝒹-1)	#A182 Power rule
# Sum and Difference Rules
𝓓ᵢ(𝓍 + 𝓎) = 𝓓ᵢ𝓍 + 𝓓ᵢ𝓎	#A183 Sum rule
# Product Rule
𝓓ᵢ(𝓍*𝓎) = 𝓓ᵢ𝓍*𝓎 + 𝓍*𝓓ᵢ𝓎	#A184 Product rule
# Quotient Rule
𝓓ᵢ(𝓍 / 𝓎) = (𝓓ᵢ(𝓍)𝓎 - 𝓍𝓓ᵢ(𝓎)) / 𝓎²	#A185 Quotient rule
𝓓ᵢ(1 / 1+𝓍) = -𝓓ᵢ𝓍 / (1+𝓍)²	#A186 From quotient rule
# Chain Rule
# This one is meta.  :-??
𝓓ᵢ𝓐𝓑𝓍 = (𝓓𝓐)𝓑𝓍*(𝓓𝓑)𝓍*𝓓ᵢ𝓍	#A187 Chain rule
# Exponential
𝓓ᵢ(𝑎∧𝓍) = ⌊𝑎𝓓ᵢ(𝓍)𝑎∧𝓍	#A188 D(a^x)=log(a)D(x)a^x
𝓓ᵢ(𝖊∧𝓍) = 𝓓ᵢ(𝓍)𝖊∧𝓍	#A189 D(e^x)=D(x)e^x
```
