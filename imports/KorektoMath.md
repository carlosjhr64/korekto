...
𝟭 ⚌ g1;S1 g1⦆S1;S1 𝟭⦆S2	#I182 a=g,_g)→_a)
g1 ⚌ 𝟭;S1 g1⦆S2;S1 𝟭⦆S2	#I183 g=a,_g)→_a)
𝟭 ⚌ g1;S1⦅g1 S1;S1⦅𝟭 S2	#I184 a=g,(g_→(a_
g1 ⚌ 𝟭;S1⦅g1 S2;S1⦅𝟭 S2	#I185 g=a,(g_→(a_
𝟭 ⚌ N2;S1𝟭S2;S1(N2)S2	#I186 a=(b),a→(b)
N1 ⚌ 𝟭;S1♭(N1)♮S2;S1♭𝟭♮S2	#I187 (a)=b,(a)→b
N1 ⚌ 𝟭;S1♭(N1)♭S2♭(N1)♭S3;S1♭𝟭♭S2♭𝟭♭S3	#I188 (a)=b,(a)→b~b
N1 ⚌ 𝟭;S1𝟭S2;S1(N1)S2	#I189 (a)=b;b→(a)
N1 ⚌ N2;S1(N1)S2;S1(N2)S2	#I190 (a)=(b),(a)→(b)
N1 ⚌ N2;S1(N2)S2;S1(N1)S2	#I191 (a)=(b),(b)→(a)
N1 ⚌ N2;N1 ⚍ S1;N2 ⚍ S1	#I192 a=b, ^a_+ → ^b_+
N1 ⚌ N2;N2 ⚍ S1;N1 ⚍ S1	#I193 a=b, ^b_+ → ^a_+
N1 ⚌ N2;S1 ⚍ N1;S1 ⚍ N2	#I194 a=b, +_a$ → +_b$
N1 ⚌ N2;S1 ⚍ N2;S1 ⚍ N1	#I195 a=b, +_b$ → +_a$
```
### Adding
```korekto
S1(𝟭 + -𝟮)S2;S1(𝟭♮-♮𝟮)S2	#M196 a+-b=a-b
S1(𝟭♭-♭𝟮)S2;S1(𝟭 + -𝟮)S2	#M197 a-b=a+-b
S1⚐𝟭∧𝟮*𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M198 a^b*a^c=a^(b+c)
S1⚐𝟭∧𝟮𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M199 a^ba^c=a^(b+c)
S1⚐𝟭∧(𝟮♭+♭𝟯)⚑S2;S1𝟭∧𝟮*𝓊𝟭∧𝟯S2	#M200 a^(b+c)=a^b*a^c
S1(𝟭♭+♭𝟮)S2;S1(𝟮♮+♮𝟭)S2	#M201 (a+b)→(b+a)
```
### Subtracting
```korekto
S1♭--𝟭♮S2;S1♭𝟭♮S2	#M202 --a→a
```
## Calculus
```korekto
# Derivatives
# Constant Rule
𝓓ᵢ𝖆 = 0	#A203 Constant rule
# Power Rule
𝓓ᵢ(𝓍∧𝖆) = 𝒹*𝓍∧(𝖆-1)	#A204 Power rule
# Sum and Difference Rules
𝓓ᵢ(𝓍 + 𝓎) = 𝓓ᵢ𝓍 + 𝓓ᵢ𝓎	#A205 Sum rule
# Product Rule
𝓓ᵢ(𝓍*𝓎) = 𝓓ᵢ𝓍*𝓎 + 𝓍*𝓓ᵢ𝓎	#A206 Product rule
# Quotient Rule
𝓓ᵢ(𝓍 / 𝓎) = (𝓓ᵢ(𝓍)𝓎 - 𝓍𝓓ᵢ(𝓎)) / 𝓎²	#A207 Quotient rule
𝓓ᵢ(1 / 1+𝓍) = -𝓓ᵢ𝓍 / (1+𝓍)²	#A208 From quotient rule
# Chain Rule
# This one is meta.  :-??
𝓓ᵢ𝓐𝓑𝓍 = (𝓓𝓐)𝓑𝓍*(𝓓𝓑)𝓍*𝓓ᵢ𝓍	#A209 Chain rule
# Exponential
𝓓ᵢ(𝖆∧𝓍) = ⌊𝖆𝓓ᵢ(𝓍)𝖆∧𝓍	#A210 D(a^x)=log(a)D(x)a^x
𝓓ᵢ(𝖊∧𝓍) = 𝓓ᵢ(𝓍)𝖊∧𝓍	#A211 D(e^x)=D(x)e^x
# Computations:
𝓓ᵢ(-𝓍) = -𝓓ᵢ(𝓍)	#A212 𝓓ₓ(-𝑦)=-𝓓(𝑦)
ᵢ → 𝑎;𝓓ᵢ𝑎 = 1	#M213 𝓓ₓ𝑥=1
ᵢ → 𝑎;𝓓ᵢ(-𝑎) = -1	#M214 𝓓ₓ-𝑥=-1
```
