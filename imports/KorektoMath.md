...
### GroupGlob grouping
```korekto
S1♭(g1)♭S2;S1 g1 S2	#M128 ♭(a)♭ → _a_
S1 g1 S2;S1♭(g1)♭S2	#M129 _a_ → ♭(a)♭
S1♭(g1);S1 g1	#M130 ♭(a)$ → _a$
S1 g1;S1♭(g1)	#M131 _a$ → ♭(a)$
(g1)♭S1;g1 S1	#M132 ^(a)♭ → ^a_
g1 S1;(g1)♭S1	#M133 ^a_ → ^(a)♭
# Nested groupings
S1 g1⦆S2;S1 (g1)⦆S2	#M134 _a)→_(a))
S1⦅g1 S2;S1⦅(g1) S2	#M135 (a_→((a)_
```
### Group grouping
```korekto
S1 ⚍ (G1) ⚎ S2;S1 ⚍ G1 ⚎ S2	#M136 +_(a)_+ → +_a_+
S1 ⚍ G1 ⚎ S2;S1 ⚍ (G1) ⚎ S2	#M137 +_a_+ → +_(a)_+
S1 ⚍ G1 ⚎ G2 ⚏ S2;S1 ⚍ (G1) ⚎ (G2) ⚏ S2	#M138 →+_(a)_+_(b)_+
S1 ⚍ (G1) ⚎ (G2) ⚏ S2;S1 ⚍ G1 ⚎ G2 ⚏ S2	#M139 →+_a_+_b_+
S1 ⚍ (G1);S1 ⚍ G1	#M140 +_(a)$ → +_a$
S1 ⚍ G1;S1 ⚍ (G1)	#M141 +_a$ → +_(a)$
(G1) ⚍ S1;G1 ⚍ S1	#M142 ^(a)_+ → ^a_+
G1 ⚍ S1;(G1) ⚍ S1	#M143 ^a_+ → ^(a)_+
# Rare cases ((a))
S1 ⚍ G1⦆S2;S1 ⚍ (G1)⦆S2	#M144 +_a)~ → +_(a))~
S1 ⚍ (G1)⦆S2;S1 ⚍ G1⦆S2	#M145 +_(a))~ → +_a)~
S1⦅G1 ⚍ S2;⦅(G1) ⚍ S2	#M146 ~(a_+ → ~((a)_+
S1⦅(G1) ⚍ S2;⦅G1 ⚍ S2	#M147 ~((a)_+ → ~(a_+
# Rare cases a+b+c
S1 ⚍ g1±g2;S1 ⚍ g1 ± g2	#M148 +_a+b$ → +_a_+_b$
g1±g2 ⚍ S2;g1 ± g2 ⚍ S2	#M149 ^a+b_+ → ^a_+_b_+
S1 ⚎ g1±g2 ⚍ S2;S1 ⚎ g1 ± g2 ⚍ S2	#M150 +_a+b_+ → +_a_+_b_+
```
### Tight grouping
```korekto
S1(𝟭♩𝟮)⚑S2;S1𝟭♩𝟮S2	#M151 (a^b) → a^b
S1𝟭♩𝟮⚑S2;S1(𝟭♩𝟮)S2	#M152 a^b → (a^b)
S1(𝟭♩𝟮)⚑S2(𝟯♪𝟰)⚑S3;S1𝟭♩𝟮S2𝟯♪𝟰S3	#M153 (a^b)~(c^d) → a^b~c^c
S1𝟭♩𝟮⚑S2𝟯♪𝟰⚑S3;S1(𝟭♩𝟮)S2(𝟯♪𝟰)S3	#M154 a^b~c^d → (a^b)~(c^c)
```
## Algebra

### Implied/Explicit multiplication
```korekto
S1𝟭♭𝟮S2;S1𝟭♮*♮𝟮S2	#M155 Explicit*
S1𝟭♮*♮𝟮S2;S1𝟭♭𝟮S2	#M156 Implied*
```
### Equality
```korekto
N1 ⚌ N2;N2 = N1	#M157 Symmetry
N1 = N1	#A158 Reflection
```
### Transitive
```korekto
N1 ⚌ N2;N2 ⚌ N3;N1 = N3	#I159 a=b;b=c;a=c
N1 ⚌ N2;N2 ⚌ N3;N3 = N1	#I160 a=b;b=c;c=a
N1 ⚌ N2;N3 ⚌ N2;N1 = N3	#I161 a=b;c=b;a=c
N1 ⚌ N2;N3 ⚌ N2;N3 = N1	#I162 a=b;c=b;c=a
```
### One
```korekto
# (a/a)
S1(𝟭♭/♭𝟭)S2;S1(1)S2	#M163 (a/a)→(1)
S1(g1 / g1)S2;S1(1)S2	#M164 (a / a)→(1)
# *One*
S1♭*♭1 S2;S1 S2	#M165 *1_
S1 1♭*♭S2;S1 S2	#M166 _1*
S1♭*♭(1) S2;S1 S2	#M167 *(1)_
S1 (1)♭*♭S2;S1 S2	#M168 _(1)*
S1*1⚑S2;S1⚑S2	#M169 *1
...
### Zero
```korekto
S1(𝟭♭-♭𝟭)S2;S1(0)S2	#M173 (a-a)→(0)
S1♭+♭𝟭♭-♭𝟭♭±♭S2;S1♭±♭S2	#M174 +a-a± → ±
S1♭+♭𝟭♭-♭𝟭;S1	#M175 +a-a$ → $
S1♭-♭𝟭♭+♭𝟭;S1	#M176 -a+a$ → $
S1+𝟭-𝟭 S2;S1 S2	#M177 +a-a_
# Order here matters. This one is tested first:
S1♭⚀♭0♭⚀♭S2;S1♭+♭S2	#M178 ±0± → +
# This one is tested after the above:
S1♭±♭0♭⚀♭S2;S1♭-♭S2	#M179 ±0+ → -
```
### (a/b)
```korekto
S1 𝟭♭/♭𝟮;S1 𝟯*𝟭 / 𝟯*𝟮	#M180 _x*a_/_x*b$
S1(𝟭♭/♭𝟮)S2;S1(𝟯*𝟭 / 𝟯*𝟮)S2	#M181 (x*a_/_x*b)
S1(g1 / g2)S2;S1(𝟭*(g1) / 𝟭*(g2))S2	#M182 (x*(a)_/_x*(b))
S1𝟭*(1♭/♭𝟮)⚑S2;S1(𝟭♮/♮𝟮)S2	#M183 x*(1/y) → (x/y)
S1𝟭*(1 / g1)⚑S2;S1(𝟭 / g1)S2	#M184 x*(1_/_y) → (x_/_y)
S1 1♭±♭(𝟭 / g2)⚑S2;S1 (g2±𝟭 / g2)S2	#M185 _1±(a_/_b) → (b±a / b)
S1 𝓍/𝓎²;S1 𝓍/𝓎 1/𝓎	#M186 _a/b²$→_a/b_1/b$
```
### Distribute
```korekto
S1𝟭*(𝟮♭±♭𝟯)⚑S2;S1(𝟭*𝟮♮±♮𝟭*𝟯)S2	#M187 (x*a♭±♭x*b)
S1𝟭*(g2 ± g3)⚑S2;S1(𝟭*(g2)♭±♭𝟭*(g3))S2	#M188 (x*(a)♭±♭x*(b))
```
### Substitution
```korekto
𝟭 ⚌ 𝟮;S1𝟭S2;S1𝟮S2	#I189 a=b,a→b
𝟭 ⚌ 𝟮;S1𝟭S2𝟭S3;S1𝟮S2𝟮S3	#I190 a=b,2*a→b
𝟭 ⚌ 𝟮;S1𝟭S2𝟭S3𝟭S4;S1𝟮S2𝟮S3𝟮S4	#I191 a=b,3*a→b
𝟭 ⚌ g1;S1 g1⦆S2;S1 𝟭⦆S2	#I192 a=g,_g)→_a)
g1 ⚌ 𝟭;S1 g1⦆S2;S1 𝟭⦆S2	#I193 g=a,_g)→_a)
𝟭 ⚌ g1;S1⦅g1 S2;S1⦅𝟭 S2	#I194 a=g,(g_→(a_
g1 ⚌ 𝟭;S1⦅g1 S2;S1⦅𝟭 S2	#I195 g=a,(g_→(a_
g1 ⚌ g2;S1 g1 S2;S1 g2 S2	#I196 a=b,_a_→_b_
g1 ⚌ g2;S1 g2 S2;S1 g1 S2	#I197 a=b,_b_→_a_
g1 ⚌ g2;S1 g1;S1 g2	#I198 a=b,_a$→_b$
g1 ⚌ g2;S1 g2;S1 g1	#I199 a=b,_b$→_a$
𝟭 ⚌ N2;S1𝟭S2;S1(N2)S2	#I200 a=(b),a→(b)
N1 ⚌ 𝟭;S1♭(N1)♮S2;S1♭𝟭♮S2	#I201 (a)=b,(a)→b
N1 ⚌ 𝟭;S1♭(N1)♭S2♭(N1)♭S3;S1♭𝟭♭S2♭𝟭♭S3	#I202 (a)=b,(a)→b~b
N1 ⚌ 𝟭;S1𝟭S2;S1(N1)S2	#I203 (a)=b;b→(a)
N1 ⚌ N2;S1(N1)S2;S1(N2)S2	#I204 (a)=(b),(a)→(b)
N1 ⚌ N2;S1(N2)S2;S1(N1)S2	#I205 (a)=(b),(b)→(a)
N1 ⚌ N2;N1 ⚍ S1;N2 ⚍ S1	#I206 a=b, ^a_+ → ^b_+
N1 ⚌ N2;N2 ⚍ S1;N1 ⚍ S1	#I207 a=b, ^b_+ → ^a_+
N1 ⚌ N2;S1 ⚍ N1;S1 ⚍ N2	#I208 a=b, +_a$ → +_b$
N1 ⚌ N2;S1 ⚍ N2;S1 ⚍ N1	#I209 a=b, +_b$ → +_a$
N1 ⚌ N2;S1 ⚍ N1 ⚎ S2;S1 ⚍ N2 ⚎ S2	#I210 a=b, +_a_+ → +_b_+
N1 ⚌ N2;S1 ⚍ N2 ⚎ S2;S1 ⚍ N1 ⚎ S2	#I211 a=b, +_b_+ → +_a_+
```
### Adding
```korekto
S1(𝟭 + -𝟮)S2;S1(𝟭♮-♮𝟮)S2	#M212 a+-b=a-b
S1(𝟭♭-♭𝟮)S2;S1(𝟭 + -𝟮)S2	#M213 a-b=a+-b
S1⚐𝟭∧𝟮*𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M214 a^b*a^c=a^(b+c)
S1⚐𝟭∧𝟮𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M215 a^ba^c=a^(b+c)
S1⚐𝟭∧(𝟮♭+♭𝟯)⚑S2;S1𝟭∧𝟮*𝟭∧𝟯S2	#M216 a^(b+c)=a^b*a^c
S1(𝟭♭+♭𝟮)S2;S1(𝟮♮+♮𝟭)S2	#M217 (a+b)→(b+a)
```
### Subtracting
```korekto
S1♭--𝟭♮S2;S1♭𝟭♮S2	#M218 --a→a
𝓍 = -𝓎;-𝓍 = 𝓎	#M219 a=-b;-a=-b
```
## Functions
```korekto
# Natural log
⌊ 𝓍/𝓎 = ⌊𝓍 - ⌊𝓎	#A220 ⌊(a/b)=⌊a-⌊b
# Squash
⌈𝓍 = 1 / 1+⌉-𝓍	#A221 Squash: ⌈
# Unsquash
⌋𝓍 = ⌊ 𝓍/(1-𝓍)	#A222 Unsquash: ⌋
# Binary balance
# 𝓑 is being used as a pattern key, so I temporarily replace it:
! replace! 𝓑 TMP
# Now I can define 𝓑 in an axiom:
𝓑𝓍 = (1-𝓍)*𝓍	#A223 Binary balance: 𝓑
! replace! TMP 𝓑
```
## Calculus
```korekto
# Derivatives
# Constant Rule
𝓓ᵢ𝖆 = 0	#A224 Constant rule
# Power Rule
𝓓ᵢ(𝓍∧𝖆) = 𝒹*𝓍∧(𝖆-1)	#A225 Power rule
# Sum and Difference Rules
𝓓ᵢ(𝓍 + 𝓎) = 𝓓ᵢ𝓍 + 𝓓ᵢ𝓎	#A226 Sum rule
# Product Rule
𝓓ᵢ(𝓍*𝓎) = 𝓓ᵢ𝓍*𝓎 + 𝓍*𝓓ᵢ𝓎	#A227 Product rule
# Quotient Rule
𝓓ᵢ(𝓍 / 𝓎) = (𝓓ᵢ(𝓍)𝓎 - 𝓍𝓓ᵢ(𝓎)) / 𝓎²	#A228 Quotient rule
𝓓ᵢ(1 / 1+𝓍) = -𝓓ᵢ𝓍 / (1+𝓍)²	#A229 From quotient rule
# Chain Rule
# This one is meta.  :-??
𝓓ᵢ𝓐𝓑𝓍 = (𝓓𝓐)𝓑𝓍*(𝓓𝓑)𝓍*𝓓ᵢ𝓍	#A230 Chain rule
# Exponential
𝓓ᵢ(𝖆∧𝓍) = ⌊𝖆𝓓ᵢ(𝓍)𝖆∧𝓍	#A231 D(a^x)=log(a)D(x)a^x
𝓓ᵢ(𝖊∧𝓍) = 𝓓ᵢ(𝓍)𝖊∧𝓍	#A232 D(e^x)=D(x)e^x
# Computations:
𝓓ᵢ(-𝓍) = -𝓓ᵢ(𝓍)	#A233 𝓓ₓ(-𝑦)=-𝓓(𝑦)
ᵢ → 𝑎;𝓓ᵢ𝑎 = 1	#M234 𝓓ₓ𝑥=1
ᵢ → 𝑎;𝓓ᵢ(-𝑎) = -1	#M235 𝓓ₓ-𝑥=-1
```
