...
### GroupGlob grouping
```korekto
S1♭(g1)♭S2;S1 g1 S2	#M123 Space
S1 g1 S2;S1♭(g1)♭S2	#M124 Group
S1♭(g1);S1 g1	#M125 Space$
S1 g1;S1♭(g1)	#M126 Group$
(g1)♭S1;g1 S1	#M127 ^Space
g1 S1;(g1)♭S1	#M128 ^Group
```
### Group grouping
```korekto
S1 ⚍ (G1) ⚎ S2;S1 ⚍ G1 ⚎ S2	#M129 +Space+
S1 ⚍ G1 ⚎ S2;S1 ⚍ (G1) ⚎ S2	#M130 +Group+
S1 ⚍ G1 ⚎ G2 ⚏ S2;S1 ⚍ (G1) ⚎ (G2) ⚏ S2	#M131 +Group+Group+
S1 ⚍ (G1);S1 ⚍ G1	#M132 +Space
S1 ⚍ G1;S1 ⚍ (G1)	#M133 +Group
(G1) ⚍ S1;G1 ⚍ S1	#M134 Space+
G1 ⚍ S1;(G1) ⚍ S1	#M135 Group+
S1 ⚍ G1⦆;S1 ⚍ (G1)⦆	#M136 +Group)
S1 ⚍ g1±g2;S1 ⚍ g1 ± g2	#M137 Space ~a+b
```
### Tight grouping
```korekto
S1(𝟭♩𝟮)S2;S1𝟭♩𝟮S2	#M138 Tight un-grouped
S1𝟭♩𝟮S2;S1(𝟭♩𝟮)S2	#M139 Tight grouped
```
## Algebra

### Implied/Explicit multiplication
```korekto
S1𝟭♭𝟮S2;S1𝟭♮*♮𝟮S2	#M140 Explicit*
S1𝟭♮*♮𝟮S2;S1𝟭♭𝟮S2	#M141 Implied*
```

### Equality
```korekto
N1 ⚌ N2;N2 = N1	#M142 Symmetry
N1 = N1	#A143 Reflection
```
### Transitive
```korekto
N1 ⚌ N2;N2 ⚌ N3;N1 = N3	#I144 Transitive a=b;b=c;a=c
N1 ⚌ N2;N3 ⚌ N2;N3 = N1	#I145 Linked a=b;c=b;c=a
```
### One
```korekto
# (a/a)
S1(𝟭♭/♭𝟭)S2;S1(1)S2	#M146 (a/a)=>(1)
S1(g1 / g1)S2;S1(1)S2	#M147 (a / a)=>(1)
# One
S1♭*♭1 S2;S1 S2	#M148 *one~
S1♭*♭(1) S2;S1 S2	#M149 *(one)~
S1 1♭*♭S2;S1 S2	#M150 ~one*
S1 (1)♭*♭S2;S1 S2	#M151 ~(one)*
S1*1⚑S2;S1⚑S2	#M152 *one
S1⚑1*S2;S1⚑S2	#M153 one*
S1*(1)⚑S2;S1⚑S2	#M154 *(one)
S1⚑(1)*S2;S1⚑S2	#M155 (one)*
```
### Zero
```korekto
S1(𝟭♭-♭𝟭)S2;S1(0)S2	#M156 (a-a)=>(0)
S1♭⚀♭𝟭♭-♭𝟭♭±♭S2;S1♭±♭S2	#M157 ±a-a±=>±
S1⚀𝟭-𝟭 S2;S1 S2	#M158 +a-a~
S1♭⚀♭0♭±♭S2;S1♭±♭S2	#M159 ±0±=>±
```
### (a/b)
```korekto
S1 𝟭♭/♭𝟮;S1 𝟯*𝟭 / 𝟯*𝟮	#M160 x*a / x*b$
S1(𝟭♭/♭𝟮)S2;S1(𝟯*𝟭 / 𝟯*𝟮)S2	#M161 (xa / xb)
S1(g1 / g2)S2;S1(𝟭*(g1) / 𝟭*(g2))S2	#M162 (x(a) / x(b))
S1𝟭*(1♭/♭𝟮)⚑S2;S1(𝟭♮/♮𝟮)S2	#M163 (x*1)/(y)
S1𝟭*(1 / g1)⚑S2;S1(𝟭 / g1)S2	#M164 x*1 /  y
S1 1♭±♭(𝟭 / g2)⚑S2;S1 (g2±𝟭 / g2)S2	#M165 ~1+(a/b)->~(b+a / b)
```
### Distribute
```korekto
S1𝟭*(𝟮♭±♭𝟯)⚑S2;S1(𝟭*𝟮♮±♮𝟭*𝟯)S2	#M166 (xa±xb)
S1𝟭*(g2 ± g3)⚑S2;S1(𝟭*(g2) ± 𝟭*(g3))S2	#M167 (x(a) ± x(b))
```
### Substitution
```korekto
𝟭 = 𝟮;S1𝟭S2;S1𝟮S2	#I168 a=b;a->b
𝟭 = N2;S1𝟭S2;S1(N2)S2	#I169 a=b;a->(b)
N1 = 𝟭;S1♭(N1)♮S2;S1♭𝟭♮S2	#I170 (a)=b;(a)->b
N1 = 𝟭;S1♭(N1)♭S2♭(N1)♭S3;S1♭𝟭♭S2♭𝟭♭S3	#I171 (a)=b;(a)->b,b
N1 = 𝟭;S1𝟭S2;S1(N1)S2	#I172 (a)=b;b->(a)
N1 = N2;S1(N1)S2;S1(N2)S2	#I173 a=b;(a)->(b)
N1 = N2;S1(N2)S2;S1(N1)S2	#I174 a=b;(b)->(a)
N1 = N2;N1 ⚍ S1;N2 ⚍ S1	#I175 a=b;a->b+
N1 = N2;N2 ⚍ S1;N1 ⚍ S1	#I176 a=b;b->a+
N1 = N2;S1 ⚍ N1;S1 ⚍ N2	#I177 a=b;a->+b
N1 = N2;S1 ⚍ N2;S1 ⚍ N1	#I178 a=b;b->+a
```
### Adding
```korekto
S1(𝟭 + -𝟮)S2;S1(𝟭♮-♮𝟮)S2	#M179 a+-b=a-b
S1(𝟭♭-♭𝟮)S2;S1(𝟭 + -𝟮)S2	#M180 a-b=a+-b
S1⚑𝟭∧𝟮*𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M181 a^b*a^c=a^(b+c)
S1⚑𝟭∧𝟮𝟭∧𝟯⚑S2;S1𝟭∧(𝟮♭+♭𝟯)S2	#M182 a^ba^c=a^(b+c)
S1⚑𝟭∧(𝟮♭+♭𝟯)⚑S2;S1𝟭∧𝟮*𝓊𝟭∧𝟯S2	#M183 a^(b+c)=a^b*a^c
S1(𝟭♭+♭𝟮)S2;S1(𝟮♮+♮𝟭)S2	#M184 (a+b)->(b+a)
```
### Subtracting
```korekto
S1♭--𝟭♮S2;S1♭𝟭♮S2	#M185 --a->a
```
## Calculus
```korekto
# Derivatives
# Constant Rule
𝓓ᵢ𝒹 = 0	#A186 Constant rule
# Power Rule
𝓓ᵢ(𝓍∧𝒹) = 𝒹*𝓍∧(𝒹-1)	#A187 Power rule
# Sum and Difference Rules
𝓓ᵢ(𝓍 + 𝓎) = 𝓓ᵢ𝓍 + 𝓓ᵢ𝓎	#A188 Sum rule
# Product Rule
𝓓ᵢ(𝓍*𝓎) = 𝓓ᵢ𝓍*𝓎 + 𝓍*𝓓ᵢ𝓎	#A189 Product rule
# Quotient Rule
𝓓ᵢ(𝓍 / 𝓎) = (𝓓ᵢ(𝓍)𝓎 - 𝓍𝓓ᵢ(𝓎)) / 𝓎²	#A190 Quotient rule
𝓓ᵢ(1 / 1+𝓍) = -𝓓ᵢ𝓍 / (1+𝓍)²	#A191 From quotient rule
# Chain Rule
# This one is meta.  :-??
𝓓ᵢ𝓐𝓑𝓍 = (𝓓𝓐)𝓑𝓍*(𝓓𝓑)𝓍*𝓓ᵢ𝓍	#A192 Chain rule
# Exponential
𝓓ᵢ(𝑎∧𝓍) = ⌊𝑎𝓓ᵢ(𝓍)𝑎∧𝓍	#A193 D(a^x)=log(a)D(x)a^x
𝓓ᵢ(𝖊∧𝓍) = 𝓓ᵢ(𝓍)𝖊∧𝓍	#A194 D(e^x)=D(x)e^x
```
