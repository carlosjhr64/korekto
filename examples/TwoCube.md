...
6 + 1 + 1 = 8	#C2/I220.KorektoMath,S50.KorektoMath,R1 G=F, ^F_+ → ^G_+
5 + 1 + 1 + 1 = 8	#C3/I220.KorektoMath,S49.KorektoMath,C2 G=F, ^F_+ → ^G_+
4 + 1 + 1 + 1 + 1 = 8	#C4/I220.KorektoMath,S48.KorektoMath,C3 G=F, ^F_+ → ^G_+
4 + (1 + 1) + (1 + 1) = 8	#R5/M146.KorektoMath,C4 →+_(G)_+_(F)_+
4 + 2 + 2 = 8	#C6/I214.KorektoMath,S45.KorektoMath,R5 G=a,(G)→a~a
3 + 1 = 4	#R7/M2.KorektoMath,S47.KorektoMath ≝→=
2 + 1 + 1 = 4	#C8/I220.KorektoMath,S46.KorektoMath,R7 G=F, ^F_+ → ^G_+
2 + (1 + 1) = 4	#R9/M145.KorektoMath,C8 +_G_+ → +_(G)_+
2 + 2 = 4	#C10/I216.KorektoMath,S45.KorektoMath,R9 G=a,(G)→a
4 + (2 + 2) = 8	#R11/M145.KorektoMath,C6 +_G_+ → +_(G)_+
4 + 4 = 8	#C12/I216.KorektoMath,C10,R11 G=a,(G)→a
# Show that 2*2=4
