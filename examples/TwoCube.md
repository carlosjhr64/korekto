...
6 + 1 + 1 = 8	#C2/I188.KorektoMath,S50.KorektoMath,R1 a=b, ^b_+ → ^a_+
5 + 1 + 1 + 1 = 8	#C3/I188.KorektoMath,S49.KorektoMath,C2 a=b, ^b_+ → ^a_+
4 + 1 + 1 + 1 + 1 = 8	#C4/I188.KorektoMath,S48.KorektoMath,C3 a=b, ^b_+ → ^a_+
4 + (1 + 1) + (1 + 1) = 8	#R5/M133.KorektoMath,C4 →+_(a)_+_(b)_+
4 + 2 + 2 = 8	#C6/I183.KorektoMath,S45.KorektoMath,R5 (a)=b,(a)→b~b
3 + 1 = 4	#R7/M2.KorektoMath,S47.KorektoMath ≝→=
2 + 1 + 1 = 4	#C8/I188.KorektoMath,S46.KorektoMath,R7 a=b, ^b_+ → ^a_+
2 + (1 + 1) = 4	#R9/M132.KorektoMath,C8 +_a_+ → +_(a)_+
2 + 2 = 4	#C10/I182.KorektoMath,S45.KorektoMath,R9 (a)=b,(a)→b
4 + (2 + 2) = 8	#R11/M132.KorektoMath,C6 +_a_+ → +_(a)_+
4 + 4 = 8	#C12/I182.KorektoMath,C10,R11 (a)=b,(a)→b
# Show that 2*2=4
4 * 2 = 8	#R13/M54.KorektoMath,C12 Double
2 * 2 = 4	#R14/M54.KorektoMath,C10 Double
# Show that 2*2*2=8
(2 * 2) * 2 = 8	#C15/I184.KorektoMath,R14,R13 (a)=b;b→(a)
