...
6 + 1 + 1 = 8	#C3/I176.KorektoMath,R2,R1 a=b;b->a+
5 + 1 = 6	#R4/M2.KorektoMath,S48.KorektoMath If equivalent, then equal
5 + 1 + 1 + 1 = 8	#C5/I176.KorektoMath,R4,C3 a=b;b->a+
4 + 1 = 5	#R6/M2.KorektoMath,S47.KorektoMath If equivalent, then equal
4 + 1 + 1 + 1 + 1 = 8	#C7/I176.KorektoMath,R6,C5 a=b;b->a+
4 + (1 + 1) + (1 + 1) = 8	#R8/M131.KorektoMath,C7 +Group+Group+
1 + 1 = 2	#R9/M2.KorektoMath,S44.KorektoMath If equivalent, then equal
4 + 2 + 2 = 8	#C10/I171.KorektoMath,R9,R8 (a)=b;(a)->b,b
...
2 + 1 + 1 = 4	#C13/I176.KorektoMath,R12,R11 a=b;b->a+
2 + (1 + 1) = 4	#R14/M130.KorektoMath,C13 +Group+
2 + 2 = 4	#C15/I170.KorektoMath,R9,R14 (a)=b;(a)->b
4 + (2 + 2) = 8	#R16/M130.KorektoMath,C10 +Group+
4 + 4 = 8	#C17/I170.KorektoMath,C15,R16 (a)=b;(a)->b
# Show that 2*2=4
4 * 2 = 8	#R18/M53.KorektoMath,C17 Double
2 * 2 = 4	#R19/M53.KorektoMath,C15 Double
# Show that 2*2*2=8
(2 * 2) * 2 = 8	#C20/I172.KorektoMath,R19,R18 (a)=b;b->(a)
