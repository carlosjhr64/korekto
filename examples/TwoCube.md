...
2 + 1 + 1 = 4	#C13/I178.KorektoMath,R12,R11 a=b;b->a+
2 + (1 + 1) = 4	#R14/M130.KorektoMath,C13 +_a_+→+_(a)_+
2 + 2 = 4	#C15/I172.KorektoMath,R9,R14 (a)=b;(a)->b
4 + (2 + 2) = 8	#R16/M130.KorektoMath,C10 +_a_+→+_(a)_+
4 + 4 = 8	#C17/I172.KorektoMath,C15,R16 (a)=b;(a)->b
# Show that 2*2=4
4 * 2 = 8	#R18/M53.KorektoMath,C17 Double
2 * 2 = 4	#R19/M53.KorektoMath,C15 Double
# Show that 2*2*2=8
(2 * 2) * 2 = 8	#C20/I174.KorektoMath,R19,R18 (a)=b;b->(a)
