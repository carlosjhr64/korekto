...
𝖊 : ∑ₙ 1/𝑛!	#S95.KorektoMath/L1.KorektoMath ≝: 𝖊
...
𝖊𝓵𝖊ˣ = 𝑥	#R15/M42.KorektoMath,S14 ∧→𝓵
# Exp and Log are inverses of eachother
𝖊𝓵(𝖊ˣ) = 𝑥	#R16/M103.KorektoMath,R15 a → (a)
𝖊𝓵(𝖊∧𝑥) = 𝑥	#C17/I235.KorektoMath,S14,R16 G=F,(F)→(G)
𝖊𝓵(𝖊∧(𝑥)) = 𝑥	#R18/M103.KorektoMath,C17 a → (a)
...
# Here its:
⌉𝑥 = 𝖊∧𝑥	#T21/A96.KorektoMath Exp
# Prove ⌉0 = 𝖊∧0 = 1
⌉0 = 𝖊∧0	#T22/A96.KorektoMath Exp
⌉0 = 𝖊∧(0)	#R23/M103.KorektoMath,T22 a → (a)
𝑥 - 𝑥 = 0	#T24/A29.KorektoMath Zero
⌉0 = 𝖊∧(𝑥 - 𝑥)	#C25/I235.KorektoMath,T24,R23 G=F,(F)→(G)
⌉0 = 𝖊∧(𝑥 + -𝑥)	#R26/M243.KorektoMath,C25 a-b=a+-b
⌉0 = 𝖊∧𝑥*𝖊∧-𝑥	#R27/M247.KorektoMath,R26 a^(b+c)=a^b*a^c
⌉0 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R28/M168.KorektoMath,R27 a^b~c^d → (a^b)~(c^c)
# Then:
𝖊∧-𝑥 = 1 / 𝖊∧𝑥	#T29/A38.KorektoMath Reciprical
⌉0 = (𝖊∧𝑥)*(1 / 𝖊∧𝑥)	#C30/I234.KorektoMath,T29,R28 G=F,(G)→(F)
...
⌉𝑥⌉-𝑥 = (⌉𝑥)*(⌉-𝑥)	#R36/M105.KorektoMath,R35 a~b → (a)~(b)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉-𝑥)	#C37/I234.KorektoMath,T21,R36 G=F,(G)→(F)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉(-𝑥))	#R38/M103.KorektoMath,C37 a → (a)
⌉(-𝑥) = 𝖊∧(-𝑥)	#T39/A96.KorektoMath Exp
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧(-𝑥))	#C40/I234.KorektoMath,T39,R38 G=F,(G)→(F)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R41/M104.KorektoMath,C40 (a) → a
...
#     Math.log(y) == x #=> true
# Here its:
⌊𝑥 = 𝖊𝓵𝑥	#T46/A97.KorektoMath Log
# So we can contract the inverse relation
𝖊𝓵(𝖊∧(𝑥)) = 𝑥	#R18/M103.KorektoMath,C17 a → (a)
⌊(𝖊∧(𝑥)) = 𝖊𝓵(𝖊∧(𝑥))	#T47/A97.KorektoMath Log
⌊(𝖊∧(𝑥)) = 𝑥	#C48/I173.KorektoMath,T47,R18 a=b;b=c;a=c
⌉(𝑥) = 𝖊∧(𝑥)	#T49/A96.KorektoMath Exp
⌊(⌉(𝑥)) = 𝑥	#C50/I235.KorektoMath,T49,C48 G=F,(F)→(G)
⌊(⌉𝑥) = 𝑥	#R51/M104.KorektoMath,C50 (a) → a
⌊⌉𝑥 = 𝑥	#R52/M104.KorektoMath,R51 (a) → a
⌊⌉𝓍 = 𝓍	#A53/R52 ⌊⌉=1
# Likewise
⌉⌊𝓍 = 𝓍	#A54 ⌉⌊=1
# If 𝖊∧0 = 1, then 𝖊𝓵1 = 0 by definition of 𝓵
⌊1 = 𝖊𝓵1	#T55/A97.KorektoMath Log
𝖊∧0 = 1	#T56/A37.KorektoMath x∧0=1
𝖊𝓵1 = 0	#R57/M42.KorektoMath,T56 ∧→𝓵
⌊1 = 0	#C58/I225.KorektoMath,R57,T55 g=f,_g$→_f$
```
### Squash
```korekto
...
#     1 / (1 + Math.exp(-𝑥))
# Here its:
⌈𝑥 = 1 / 1+⌉-𝑥	#T59/A260.KorektoMath Squash
⌈𝑥 = 1 / (1 + ⌉-𝑥)	#R60/M112.KorektoMath,T59 _a+b$ → ♭(a♭+♭b)$
# Alternate
⌈𝑥 = ⌉𝑥*1 / ⌉𝑥*(1 + ⌉-𝑥)	#R61/M192.KorektoMath,R60 _x*a_/_x*b$
⌈𝑥 = ⌉𝑥 / ⌉𝑥*(1 + ⌉-𝑥)	#R62/M179.KorektoMath,R61 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥*1 + ⌉𝑥*⌉-𝑥)	#R63/M212.KorektoMath,R62 (x*a♭±♭x*b)
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥*⌉-𝑥)	#R64/M179.KorektoMath,R63 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥⌉-𝑥)	#R65/M170.KorektoMath,R64 Implied*
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + 1)	#C66/I220.KorektoMath,C43,R65 g=a,_g)→_a)
⌈𝑥 = ⌉𝑥 / (1 + ⌉𝑥)	#R67/M248.KorektoMath,C66 (a+b)→(b+a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R68/M111.KorektoMath,R67 ♭(a♭+♭b)$ → _a+b$
⌈𝓍 = ⌉𝓍 / 1+⌉𝓍	#A69/R68 Alternate Squash
# Equivalence 1-⌈𝑥 = ⌈-𝑥
1-⌈𝑥 = 1-⌈𝑥	#T70/A172.KorektoMath Reflection
1-⌈𝑥 = 1 - ⌈𝑥	#R71/M162.KorektoMath,T70 +_g+f$ → +_g_+_f$
1-⌈𝑥 = 1 - (⌉𝑥 / 1+⌉𝑥)	#C72/I229.KorektoMath,R68,R71 a=G,a→(G)
...
# Consider ⌈0
⌈0 = ⌈0	#T76/A172.KorektoMath Reflection
⌈0 = ⌉0 / 1+⌉0	#T77/A69 Alternate Squash
⌉0 = 𝖊∧0	#T22/A96.KorektoMath Exp
𝖊∧0 = 1	#T56/A37.KorektoMath x∧0=1
⌉0 = 1	#C78/I225.KorektoMath,T56,T22 g=f,_g$→_f$
⌈0 = 1 / 1+1	#C79/I217.KorektoMath,C78,T77 a=b,2*a→b
1 + 1 : 2	#S47.KorektoMath/L1.KorektoMath ≝: 2
1 + 1 = 2	#R80/M2.KorektoMath,S47.KorektoMath ≝→=
2 = 1 + 1	#R81/M171.KorektoMath,R80 Symmetry
2 = (1 + 1)	#R82/M155.KorektoMath,R81 +_G$ → +_(G)$
2 = (1+1)	#R83/M109.KorektoMath,R82 (a_+_b) → (a+b)
2 = 1+1	#R84/M111.KorektoMath,R83 ♭(a♭+♭b)$ → _a+b$
⌈0 = 1 / 2	#C85/I226.KorektoMath,R84,C79 g=f,_f$→_g$
⌈0 = 1/2	#R86/M118.KorektoMath,C85 _a_*_b$ → _a*b$
½ : 1/2	#S203.KorektoMath/L1.KorektoMath ≝: ½
⌈0 = ½	#C87/I176.KorektoMath,S203.KorektoMath,R86 a=b;c=b;c=a
# Consider ⌈1
⌈1 = ⌈1	#T88/A172.KorektoMath Reflection
⌈1 = ⌉1 / 1+⌉1	#T89/A69 Alternate Squash
⌉1 = 𝖊∧1	#T90/A96.KorektoMath Exp
𝖊∧1 = 𝖊	#T91/A36.KorektoMath x∧1=x
⌉1 = 𝖊	#C92/I225.KorektoMath,T91,T90 g=f,_g$→_f$
⌈1 = 𝖊 / 1+𝖊	#C93/I217.KorektoMath,C92,T89 a=b,2*a→b
# Consider ⌈-𝑥
⌈-𝑥 = ⌈-𝑥	#T94/A172.KorektoMath Reflection
⌈-𝑥 = 1 / 1+⌉--𝑥	#T95/A260.KorektoMath Squash
⌈-𝑥 = 1 / 1+⌉𝑥	#R96/M250.KorektoMath,T95 --a→a
# Then:
1-⌈𝑥 = ⌈-𝑥	#C97/I176.KorektoMath,R96,R75 a=b;c=b;c=a
1-⌈𝓍 = ⌈-𝓍	#A98/C97 1-⌈𝑥=⌈-𝑥
⌈-𝑥 = 1-⌈𝑥	#R99/M171.KorektoMath,C97 Symmetry
⌈-𝓍 = 1-⌈𝓍	#A100/R99 ⌈-𝑥=1-⌈𝑥
# Corrolary: ⌈𝑥+⌈-𝑥 = 1
⌈𝑥+⌈-𝑥 = ⌈𝑥+⌈-𝑥	#T101/A172.KorektoMath Reflection
⌈𝑥+⌈-𝑥 = ⌈𝑥 + ⌈-𝑥	#R102/M162.KorektoMath,T101 +_g+f$ → +_g_+_f$
⌈𝑥+⌈-𝑥 = ⌈𝑥 + 1-⌈𝑥	#C103/I225.KorektoMath,R99,R102 g=f,_g$→_f$
⌈𝑥+⌈-𝑥 = ⌈𝑥 + 1 - ⌈𝑥	#R104/M162.KorektoMath,C103 +_g+f$ → +_g_+_f$
⌈𝑥+⌈-𝑥 = (⌈𝑥 + 1) - ⌈𝑥	#R105/M151.KorektoMath,R104 +_G_+ → +_(G)_+
⌈𝑥+⌈-𝑥 = (1 + ⌈𝑥) - ⌈𝑥	#R106/M248.KorektoMath,R105 (a+b)→(b+a)
⌈𝑥+⌈-𝑥 = 1 + ⌈𝑥 - ⌈𝑥	#R107/M150.KorektoMath,R106 +_(G)_+ → +_G_+
⌈𝑥+⌈-𝑥 = 1	#R108/M184.KorektoMath,R107 +a-a$ → $
# Derivative:
# Label 𝑥
ₓ → 𝑥	#S109/L20.KorektoMath Replace: ₓ
# ₓ → 𝑥;𝓓ₓ𝓐(𝑥) = ...
𝓓ₓ⌈𝑥 = 𝓓ₓ⌈𝑥	#T110/A172.KorektoMath Reflection
𝓓ₓ⌈𝑥 = 𝓓ₓ(⌈𝑥)	#R111/M103.KorektoMath,T110 a → (a)
𝓓ₓ⌈𝑥 = 𝓓ₓ(1 / 1+⌉-𝑥)	#C112/I234.KorektoMath,T59,R111 G=F,(G)→(F)
𝓓ₓ(1 / 1+⌉-𝑥) = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#T113/A268.KorektoMath From quotient rule
𝓓ₓ⌈𝑥 = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#C114/I238.KorektoMath,T113,C112 G=F, +_G$ → +_F$
# Consider 𝓓ₓ⌉-𝑥
𝓓ₓ⌉-𝑥 = 𝓓ₓ⌉-𝑥	#T115/A172.KorektoMath Reflection
𝓓ₓ⌉-𝑥 = 𝓓ₓ(⌉-𝑥)	#R116/M103.KorektoMath,T115 a → (a)
⌉-𝑥 = 𝖊∧-𝑥	#T117/A96.KorektoMath Exp
𝓓ₓ⌉-𝑥 = 𝓓ₓ(𝖊∧-𝑥)	#C118/I234.KorektoMath,T117,R116 G=F,(G)→(F)
𝓓ₓ(𝖊∧-𝑥) = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#T119/A270.KorektoMath D(e^x)=D(x)e^x
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#C120/I225.KorektoMath,T119,C118 g=f,_g$→_f$
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)*𝖊∧-𝑥	#R121/M169.KorektoMath,C120 Explicit*
𝓓ₓ(-𝑥) = -1	#R122/M273.KorektoMath,S109 𝓓ₓ-𝑥=-1
𝓓ₓ⌉-𝑥 = -1*𝖊∧-𝑥	#C123/I216.KorektoMath,R122,R121 a=b,a→b
𝓓ₓ⌉-𝑥 = -𝖊∧-𝑥	#R124/M180.KorektoMath,C123 _1*
𝓓ₓ⌉-𝑥 = -(𝖊∧-𝑥)	#R125/M166.KorektoMath,R124 a^b → (a^b)
-𝓓ₓ⌉-𝑥 = (𝖊∧-𝑥)	#R126/M251.KorektoMath,R125 a=-b;-a=-b
# Substituting
𝓓ₓ⌈𝑥 = (𝖊∧-𝑥) / (1+⌉-𝑥)²	#C127/I216.KorektoMath,R126,C114 a=b,a→b
𝓓ₓ⌈𝑥 = 𝖊∧-𝑥 / (1+⌉-𝑥)²	#R128/M142.KorektoMath,C127 ♭(g)♭ → _g_
𝓓ₓ⌈𝑥 = ⌉-𝑥 / (1+⌉-𝑥)²	#C129/I224.KorektoMath,T117,R128 g=f,_f_→_g_
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥)²	#R130/M118.KorektoMath,C129 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) 1/(1+⌉-𝑥)	#R131/M200.KorektoMath,R130 _a/b²$→_a/b_1/b$
⌈𝑥 = 1 / (1 + ⌉-𝑥)	#R60/M112.KorektoMath,T59 _a+b$ → ♭(a♭+♭b)$
⌈𝑥 = 1 / (1+⌉-𝑥)	#R132/M109.KorektoMath,R60 (a_+_b) → (a+b)
⌈𝑥 = 1/(1+⌉-𝑥)	#R133/M118.KorektoMath,R132 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) ⌈𝑥	#C134/I226.KorektoMath,R133,R131 g=f,_f$→_g$
⌈-𝑥 = ⌉-𝑥 / 1+⌉-𝑥	#T135/A69 Alternate Squash
⌈-𝑥 = ⌉-𝑥 / (1+⌉-𝑥)	#R136/M112.KorektoMath,T135 _a+b$ → ♭(a♭+♭b)$
⌈-𝑥 = ⌉-𝑥/(1+⌉-𝑥)	#R137/M118.KorektoMath,R136 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌈-𝑥 ⌈𝑥	#C138/I224.KorektoMath,R137,C134 g=f,_f_→_g_
𝓓ₓ⌈𝑥 = 1-⌈𝑥 ⌈𝑥	#C139/I223.KorektoMath,R99,C138 g=f,_g_→_f_
𝓓ₓ⌈𝑥 = (1-⌈𝑥) ⌈𝑥	#R140/M115.KorektoMath,C139 _a+b_ → ♭(a♭+♭b)♭
𝓓ₓ⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#R141/M169.KorektoMath,R140 Explicit*
𝓑⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#T142/A262.KorektoMath Binary balance
𝓓ₓ⌈𝑥 = 𝓑⌈𝑥	#C143/I176.KorektoMath,T142,R141 a=b;c=b;c=a
```
### Unsquash
```korekto
...
#   Math.log(𝑥 / (1 - 𝑥))
# Here  its:
⌋𝑥 = ⌊ 𝑥/(1-𝑥)	#T144/A261.KorektoMath Unsquash
# Show that unsquash is the inverse of squash(⌋⌈=1):
⌋⌈𝑥 = ⌋⌈𝑥	#T145/A172.KorektoMath Reflection
⌋⌈𝑥 = ⌊ ⌈𝑥/(1-⌈𝑥)	#T146/A261.KorektoMath Unsquash
⌊ ⌈𝑥/(1-⌈𝑥) = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#T147/A259.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#C148/I238.KorektoMath,T147,T146 G=F, +_G$ → +_F$
⌋⌈𝑥 = ⌊(⌈𝑥) - ⌊(1-⌈𝑥)	#R149/M103.KorektoMath,C148 a → (a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R68/M111.KorektoMath,R67 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = ⌊(⌉𝑥 / 1+⌉𝑥) - ⌊(1-⌈𝑥)	#C150/I234.KorektoMath,R68,R149 G=F,(G)→(F)
⌋⌈𝑥 = ⌊ ⌉𝑥/(1+⌉𝑥) - ⌊(1-⌈𝑥)	#R151/M130.KorektoMath,C150 ♭(a_*_g)♭ → _a*(g)_
⌊ ⌉𝑥/(1+⌉𝑥) = ⌊⌉𝑥 - ⌊(1+⌉𝑥)	#T152/A259.KorektoMath ⌊(a/b)=⌊a-⌊b
⌊⌉𝑥 = 𝑥	#R52/M104.KorektoMath,R51 (a) → a
⌊ ⌉𝑥/(1+⌉𝑥) = 𝑥 - ⌊(1+⌉𝑥)	#C153/I216.KorektoMath,R52,T152 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊(1-⌈𝑥)	#C154/I240.KorektoMath,C153,R151 G=F, +_G_+ → +_F_+
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-⌈𝑥	#R155/M111.KorektoMath,C154 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌈𝑥)	#R156/M103.KorektoMath,R155 a → (a)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌉𝑥 / 1+⌉𝑥)	#C157/I234.KorektoMath,R68,R156 G=F,(G)→(F)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R158/M199.KorektoMath,C157 _1±(a_/_g) → (g±a / g)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1 / 1+⌉𝑥)	#R159/M186.KorektoMath,R158 +a-a_
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1/(1+⌉𝑥)	#R160/M132.KorektoMath,R159 ♭(a_*_g)$ → _a*(g)$
⌊ 1/(1+⌉𝑥) = ⌊1 - ⌊(1+⌉𝑥)	#T161/A259.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊1 - ⌊(1+⌉𝑥)	#C162/I238.KorektoMath,T161,R160 G=F, +_G$ → +_F$
⌊1 = 0	#C58/I225.KorektoMath,R57,T55 a=b,_a$→_b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - 0 - ⌊(1+⌉𝑥)	#C163/I216.KorektoMath,C58,C162 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) + ⌊(1+⌉𝑥)	#R164/M190.KorektoMath,C163 ±0± → +
⌋⌈𝑥 = 𝑥	#R165/M185.KorektoMath,R164 -a+a$ → $
...
ₛ → ˢ	#C11/I11.KorektoMath,S5,S6 2nd
∑ₛ(𝑾ᵣₛ𝒂ₛ) = 𝑾ᵣˢ𝒂ₛ	#R170/M274.KorektoMath,C11 Einstein notation
𝒂ᵣ = ⌈ 𝒃ᵣ+(𝑾ᵣˢ𝒂ₛ)	#C171/I229.KorektoMath,R170,R169 a=G,a→(G)
𝒂ᵣ = ⌈ 𝒃ᵣ+𝑾ᵣˢ𝒂ₛ	#R172/M138.KorektoMath,C171 *(ab)$ → *ab$
...
⌋𝒂 = ⌋⌈ 𝒃+𝑾𝒂₊	#R174/M254.KorektoMath,H173 x_=_G_g;Fx_=_FG_g
⌋⌈(𝒃+𝑾𝒂₊) = (𝒃+𝑾𝒂₊)	#T175/A166 Inverse
⌋⌈(𝒃+𝑾𝒂₊) = 𝒃+𝑾𝒂₊	#R176/M144.KorektoMath,T175 ♭(g)$ → _g$
⌋⌈ 𝒃+𝑾𝒂₊ = 𝒃+𝑾𝒂₊	#R177/M142.KorektoMath,R176 ♭(g)♭ → _g_
⌋𝒂 = 𝒃+𝑾𝒂₊	#C178/I238.KorektoMath,R177,R174 G=F, +_G$ → +_F$
# Neuron's value
𝒗 : ⌋𝒂	#S179/L1.KorektoMath ≝: 𝒗
𝒗 = 𝒃+𝑾𝒂₊	#C180/I173.KorektoMath,S179,C178 a=b;b=c;a=c
# Explicit 𝒗
...
𝕧 = 𝖇+𝖜*⌈𝕧	#R185/M171.KorektoMath,S183 Symmetry
0 = 𝖇+𝖜*⌈0	#H186 Case 0∊𝕧
⌈0 = ½	#C87/I176.KorektoMath,S203.KorektoMath,R86 a=b;c=b;c=a
0 = 𝖇+𝖜*½	#C187/I216.KorektoMath,C87,H186 a=b,a→b
0 = 𝖇+½𝖜	#R188/M204.KorektoMath,C187 a*½→½a
-𝖇 = ½𝖜	#R189/M252.KorektoMath,R188 0=b+g→-b=g
𝖇 = -½𝖜	#R190/M256.KorektoMath,R189 -a=bc→a=-bc
-½𝖜 = 𝖇	#R191/M171.KorektoMath,R190 Symmetry
𝖜 = -2𝖇	#R192/M205.KorektoMath,R190 a=½b→b=2a
𝕧[1]	#R193/M4.KorektoMath,S182 Membership
𝕧 = 𝖇+𝖜*⌈𝕧	#R185/M171.KorektoMath,S183 ≝→=
1 = 𝖇+𝖜*⌈1	#H194 Case 1∊𝕧
1 = 𝖇 + 𝖜*⌈1	#R195/M162.KorektoMath,H194 +_g+f$ → +_g_+_f$
1 = -½𝖜 + 𝖜*⌈1	#C196/I224.KorektoMath,R191,R195 g=f,_f_→_g_
1 = -½𝖜 + 𝖜⌈1	#R197/M170.KorektoMath,C196 Implied*
1 = 𝖜⌈1 + -½𝖜	#R198/M249.KorektoMath,R197 _g_+_f$→_f_+_g$
1 = 𝖜⌈1 - ½𝖜	#R199/M245.KorektoMath,R198 _g_+_-f$→_g_-_f$
1 = 𝖜(⌈1 - ½)	#R200/M214.KorektoMath,R199 _ab_+Na$→_a(b+N)$
𝖜 = 1/(⌈1 - ½)	#R201/M257.KorektoMath,R200 1=ab→a=1/b
𝖜 = 1 / ⌈1-½	#R202/M123.KorektoMath,R201 _a/(b♭+♭c)$→_a_/_b+c$
𝖜 = -2 / 1-2⌈1	#R203/M207.KorektoMath,R202 _1_/_a-½$→_-2_/_1-2a
𝖇 = -½𝖜	#R190/M256.KorektoMath,R189 -a=bc→a=-bc
𝖇 = -½(-2 / 1-2⌈1)	#C204/I229.KorektoMath,R203,R190 a=G,a→(G)
𝖇 = (1 / 1-2⌈1)	#R205/M208.KorektoMath,C204 _½(2 / g)→_(1 / g)
𝖇 = 1 / 1-2⌈1	#R206/M154.KorektoMath,R205 +_(G)$ → +_G$
𝕧[-1]	#R207/M4.KorektoMath,S182 Membership
𝕧 = 𝖇+𝖜*⌈𝕧	#R185/M171.KorektoMath,S183 ≝→=
-1 = 𝖇+𝖜*⌈-1	#H208 Case -1∊𝕧
⌈-1 = 1-⌈1	#T209/A100 ⌈-𝑥=1-⌈𝑥
-1 = 𝖇+𝖜*(1-⌈1)	#C210/I229.KorektoMath,T209,H208 a=G,a→(G)
-1 = 𝖇 + 𝖜*(1-⌈1)	#R211/M162.KorektoMath,C210 +_g+f$ → +_g_+_f$
-1 = -½𝖜 + 𝖜*(1-⌈1)	#C212/I223.KorektoMath,R190,R211 g=f,_g_→_f_
-1 = -½𝖜 + 𝖜(1-⌈1)	#R213/M170.KorektoMath,C212 Implied*
-1 = 𝖜(-½ + (1-⌈1))	#R214/M215.KorektoMath,R213 _Na+ab$→_a(N+b)$
-1 = 𝖜(-½ + (1 - ⌈1))	#R215/M110.KorektoMath,R214 (a+b) → (a_+_b)
-1 = 𝖜(-½ + 1 - ⌈1)	#R216/M159.KorektoMath,R215 +_(G))~ → +_G)~
-1 = 𝖜(½ - ⌈1)	#R217/M209.KorektoMath,R216 (-½+1+g)→(½+g)
𝖜 = 1/(⌈1-½)	#R218/M258.KorektoMath,R217 -1=a(b-c)→a=1/(c-b)
𝖜 = 1 / ⌈1-½	#R202/M123.KorektoMath,R201 _a/(b♭+♭c)$→_a_/_b+c$
𝖜 = 2 / 2⌈1-1	#R219/M210.KorektoMath,R202 _1_/_a+½$→_2_/_2a_1
𝖇 = -½(2 / 2⌈1-1)	#C220/I229.KorektoMath,R219,R190 a=G,a→(G)
𝖇 = -1 / 2⌈1-1	#R221/M211.KorektoMath,C220 _½(2_/_g)$→_1_/_g
...
-1 = 𝖇 + 𝖜*⌈-1	#R222/M162.KorektoMath,H208 +_g+f$ → +_g_+_f$
-1 = -½𝖜 + 𝖜*⌈-1	#C223/I232.KorektoMath,T209,C212 a=G,(G)→a
-1 = 𝖜(-½ + ⌈-1)	#C224/I232.KorektoMath,T209,R214 a=G,(G)→a
-1 = 𝖜(-½ + (1-⌈1))	#R214/M215.KorektoMath,R213 _Na+ab$→_a(N+b)$
-1 = 𝖜(-½ + (1 - ⌈1))	#R215/M110.KorektoMath,R214 (a+b) → (a_+_b)
-1 = 𝖜(-½ + 1 - ⌈1)	#R216/M159.KorektoMath,R215 +_(G))~ → +_G)~
-1 = 𝖜(½ - ⌈1)	#R217/M209.KorektoMath,R216 (-½+1+g)→(½+g)
