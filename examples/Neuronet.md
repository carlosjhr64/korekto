...
⌊1 = 0	#C51/I185.KorektoMath,R50,T48 a=b,_a$→_b$
# Prove ⌉(⌊(𝑥)) = x
⌉(⌊(𝑥)) = ⌉(⌊(𝑥))	#T52/A150.KorektoMath Reflection
...
⌈𝑥 = ⌉𝑥*(1) / ⌉𝑥*(1 + ⌉-𝑥)	#R70/M169.KorektoMath,R69 _x*a_/_x*b$
⌈𝑥 = ⌉𝑥 / ⌉𝑥*(1 + ⌉-𝑥)	#R71/M159.KorektoMath,R70 *(1)_
⌈𝑥 = ⌉𝑥 / (⌉𝑥*1 + ⌉𝑥*⌉-𝑥)	#R72/M176.KorektoMath,R71 (x*a♭±♭x*b)
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥*⌉-𝑥)	#R73/M157.KorektoMath,R72 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥⌉-𝑥)	#R74/M148.KorektoMath,R73 Implied*
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + 1)	#C75/I180.KorektoMath,C44,R74 g=a,_g)→_a)
⌈𝑥 = ⌉𝑥 / (1 + ⌉𝑥)	#R76/M202.KorektoMath,C75 (a+b)→(b+a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R77/M102.KorektoMath,R76 ♭(a♭+♭b)$ → _a+b$
⌈𝓍 = ⌉𝓍 / 1+⌉𝓍	#A78/R77 Alternate Squash
# Equivalence 1-⌈𝑥 = ⌈-𝑥
1-⌈𝑥 = 1-⌈𝑥	#T79/A150.KorektoMath Reflection
1-⌈𝑥 = 1 - ⌈𝑥	#R80/M140.KorektoMath,T79 +_a+b$ → +_a_+_b$
1-⌈𝑥 = 1 - (⌉𝑥 / 1+⌉𝑥)	#C81/I187.KorektoMath,R77,R80 a=(b),a→(b)
1-⌈𝑥 = (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R82/M174.KorektoMath,C81 _1±(a_/_b) → (b±a / b)
1-⌈𝑥 = 1+⌉𝑥-⌉𝑥 / 1+⌉𝑥	#R83/M132.KorektoMath,R82 +_(a)$ → +_a$
1-⌈𝑥 = 1 / 1+⌉𝑥	#R84/M167.KorektoMath,R83 +a-a_
# Cosider ⌈-𝑥
⌈-𝑥 = ⌈-𝑥	#T85/A150.KorektoMath Reflection
⌈-𝑥 = 1 / 1+⌉--𝑥	#T86/A66 Squash
⌈-𝑥 = 1 / 1+⌉𝑥	#R87/M203.KorektoMath,T86 --a→a
# Then:
1-⌈𝑥 = ⌈-𝑥	#C88/I154.KorektoMath,R87,R84 a=b;c=b;c=a
1-⌈𝓍 = ⌈-𝓍	#A89/C88 1-⌈𝑥=⌈-𝑥
⌈-𝑥 = 1-⌈𝑥	#R90/M149.KorektoMath,C88 Symmetry
⌈-𝓍 = 1-⌈𝓍	#A91/R90 ⌈-𝑥=1-⌈𝑥
# Derivative:
# Label 𝑥
ₓ → 𝑥	#S92/L71.KorektoMath Map: ₓ
# ₓ → 𝑥;𝓓ₓ𝓐(𝑥) = ...
𝓓ₓ⌈𝑥 = 𝓓ₓ⌈𝑥	#T93/A150.KorektoMath Reflection
𝓓ₓ⌈𝑥 = 𝓓ₓ(⌈𝑥)	#R94/M94.KorektoMath,T93 a → (a)
𝓓ₓ⌈𝑥 = 𝓓ₓ(1 / 1+⌉-𝑥)	#C95/I191.KorektoMath,T67,R94 (a)=(b),(a)→(b)
𝓓ₓ(1 / 1+⌉-𝑥) = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#T96/A212.KorektoMath From quotient rule
𝓓ₓ⌈𝑥 = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#C97/I195.KorektoMath,T96,C95 a=b, +_a$ → +_b$
# Consider 𝓓ₓ⌉-𝑥
𝓓ₓ⌉-𝑥 = 𝓓ₓ⌉-𝑥	#T98/A150.KorektoMath Reflection
𝓓ₓ⌉-𝑥 = 𝓓ₓ(⌉-𝑥)	#R99/M94.KorektoMath,T98 a → (a)
⌉-𝑥 = 𝖊∧-𝑥	#T100/A87.KorektoMath Exp
𝓓ₓ⌉-𝑥 = 𝓓ₓ(𝖊∧-𝑥)	#C101/I191.KorektoMath,T100,R99 (a)=(b),(a)→(b)
𝓓ₓ(𝖊∧-𝑥) = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#T102/A215.KorektoMath D(e^x)=D(x)e^x
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#C103/I185.KorektoMath,T102,C101 a=b,_a$→_b$
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)*𝖊∧-𝑥	#R104/M147.KorektoMath,C103 Explicit*
...
𝓓ₓ⌈𝑥 = 𝖊∧-𝑥 / (1+⌉-𝑥)²	#R111/M120.KorektoMath,C110 ♭(a)♭ → _a_
𝓓ₓ⌈𝑥 = ⌉-𝑥 / (1+⌉-𝑥)²	#C112/I184.KorektoMath,T100,R111 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥)²	#R113/M109.KorektoMath,C112 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) 1/(1+⌉-𝑥)	#R114/M175.KorektoMath,R113 _a/b²$→_a/b_1/b$
⌈𝑥 = 1 / (1+⌉-𝑥)	#R115/M100.KorektoMath,R68 (a_+_b) → (a+b)
⌈𝑥 = 1/(1+⌉-𝑥)	#R116/M109.KorektoMath,R115 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) ⌈𝑥	#C117/I186.KorektoMath,R116,R114 a=b,_b$→_a$
...
𝓓ₓ⌈𝑥 = ⌈-𝑥 ⌈𝑥	#C121/I184.KorektoMath,R120,C117 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = 1-⌈𝑥 ⌈𝑥	#C122/I183.KorektoMath,R90,C121 a=b,_a_→_b_
𝓓ₓ⌈𝑥 = (1-⌈𝑥) ⌈𝑥	#R123/M106.KorektoMath,C122 _a+b_ → ♭(a♭+♭b)♭
𝓓ₓ⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#R124/M147.KorektoMath,R123 Explicit*
𝓑⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#T125/A206.KorektoMath Binary balance
𝓓ₓ⌈𝑥 = 𝓑⌈𝑥	#C126/I154.KorektoMath,T125,R124 a=b;c=b;c=a
```
### Unsquash
```korekto
...
⌋⌈𝑥 = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#C131/I195.KorektoMath,T130,T129 a=b, +_a$ → +_b$
⌋⌈𝑥 = ⌊(⌈𝑥) - ⌊(1-⌈𝑥)	#R132/M94.KorektoMath,C131 a → (a)
# ⌈𝑥 = ⌉𝑥 / 1+⌉𝑥
⌋⌈𝑥 = ⌊(⌉𝑥 / 1+⌉𝑥) - ⌊(1-⌈𝑥)	#C133/I191.KorektoMath,R77,R132 (a)=(b),(a)→(b)
⌋⌈𝑥 = ⌊(⌉𝑥 / (1+⌉𝑥)) - ⌊(1-⌈𝑥)	#R134/M126.KorektoMath,C133 _a)→_(a))
⌋⌈𝑥 = ⌊(⌉𝑥/(1+⌉𝑥)) - ⌊(1-⌈𝑥)	#R135/M100.KorektoMath,R134 (a_+_b) → (a+b)
⌊ ⌉𝑥/(1+⌉𝑥) = ⌊⌉𝑥 - ⌊(1+⌉𝑥)	#T136/A205.KorektoMath ⌊(a/b)=⌊a-⌊b
⌊(⌉𝑥/(1+⌉𝑥)) = ⌊⌉𝑥 - ⌊(1+⌉𝑥)	#R137/M106.KorektoMath,T136 _a+b_ → ♭(a♭+♭b)♭
⌋⌈𝑥 = (⌊⌉𝑥 - ⌊(1+⌉𝑥)) - ⌊(1-⌈𝑥)	#C138/I187.KorektoMath,R137,R135 a=(b),a→(b)
⌋⌈𝑥 = ⌊⌉𝑥 - ⌊(1+⌉𝑥) - ⌊(1-⌈𝑥)	#R139/M128.KorektoMath,C138 +_(a)_+ → +_a_+
⌊⌉(𝑥) = 1 #W
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊(1-⌈𝑥)	#W
! stop!
