...
𝖊𝓵(𝖊∧𝑥) = 𝑥	#C16/I213.KorektoMath,S13,R15 (a)=(b),(b)→(a)
...
⌉0 = 𝖊∧(𝑥 - 𝑥)	#C24/I213.KorektoMath,T23,R22 (a)=(b),(b)→(a)
⌉0 = 𝖊∧(𝑥 + -𝑥)	#R25/M221.KorektoMath,C24 a-b=a+-b
⌉0 = 𝖊∧𝑥*𝖊∧-𝑥	#R26/M224.KorektoMath,R25 a^(b+c)=a^b*a^c
⌉0 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R27/M162.KorektoMath,R26 a^b~c^d → (a^b)~(c^c)
# Then:
𝖊∧-𝑥 = 1 / 𝖊∧𝑥	#T28/A36.KorektoMath Reciprical
⌉0 = (𝖊∧𝑥)*(1 / 𝖊∧𝑥)	#C29/I212.KorektoMath,T28,R27 (a)=(b),(a)→(b)
...
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉-𝑥)	#C37/I212.KorektoMath,T20,R36 (a)=(b),(a)→(b)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉(-𝑥))	#R38/M98.KorektoMath,C37 a → (a)
⌉(-𝑥) = 𝖊∧(-𝑥)	#T39/A91.KorektoMath Exp
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧(-𝑥))	#C40/I212.KorektoMath,T39,R38 (a)=(b),(a)→(b)
...
⌊(⌉(𝑥)) = 𝑥	#C50/I213.KorektoMath,T49,C48 (a)=(b),(b)→(a)
...
⌊1 = 0	#C58/I206.KorektoMath,R57,T55 a=b,_a$→_b$
```
### Squash
```korekto
...
#     1 / (1 + Math.exp(-𝑥))
# Here its:
⌈𝑥 = 1 / 1+⌉-𝑥	#T59/A230.KorektoMath Squash
⌈𝑥 = 1 / (1 + ⌉-𝑥)	#R60/M107.KorektoMath,T59 _a+b$ → ♭(a♭+♭b)$
# Alternate
⌈𝑥 = (1) / (1 + ⌉-𝑥)	#R61/M98.KorektoMath,R60 a → (a)
⌈𝑥 = ⌉𝑥*(1) / ⌉𝑥*(1 + ⌉-𝑥)	#R62/M188.KorektoMath,R61 _x*a_/_x*b$
⌈𝑥 = ⌉𝑥 / ⌉𝑥*(1 + ⌉-𝑥)	#R63/M175.KorektoMath,R62 *(1)_
⌈𝑥 = ⌉𝑥 / (⌉𝑥*1 + ⌉𝑥*⌉-𝑥)	#R64/M195.KorektoMath,R63 (x*a♭±♭x*b)
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥*⌉-𝑥)	#R65/M173.KorektoMath,R64 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥⌉-𝑥)	#R66/M164.KorektoMath,R65 Implied*
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + 1)	#C67/I201.KorektoMath,C43,R66 g=a,_g)→_a)
⌈𝑥 = ⌉𝑥 / (1 + ⌉𝑥)	#R68/M225.KorektoMath,C67 (a+b)→(b+a)
...
1-⌈𝑥 = 1 - (⌉𝑥 / 1+⌉𝑥)	#C73/I208.KorektoMath,R69,R72 a=(b),a→(b)
1-⌈𝑥 = (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R74/M193.KorektoMath,C73 _1±(a_/_b) → (b±a / b)
1-⌈𝑥 = 1+⌉𝑥-⌉𝑥 / 1+⌉𝑥	#R75/M148.KorektoMath,R74 +_(G)$ → +_G$
1-⌈𝑥 = 1 / 1+⌉𝑥	#R76/M185.KorektoMath,R75 +a-a_
# Cosider ⌈-𝑥
⌈-𝑥 = ⌈-𝑥	#T77/A166.KorektoMath Reflection
⌈-𝑥 = 1 / 1+⌉--𝑥	#T78/A230.KorektoMath Squash
⌈-𝑥 = 1 / 1+⌉𝑥	#R79/M226.KorektoMath,T78 --a→a
# Then:
...
𝓓ₓ⌈𝑥 = 𝓓ₓ(1 / 1+⌉-𝑥)	#C94/I212.KorektoMath,T59,R93 (a)=(b),(a)→(b)
𝓓ₓ(1 / 1+⌉-𝑥) = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#T95/A238.KorektoMath From quotient rule
𝓓ₓ⌈𝑥 = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#C96/I216.KorektoMath,T95,C94 a=b, +_a$ → +_b$
# Consider 𝓓ₓ⌉-𝑥
𝓓ₓ⌉-𝑥 = 𝓓ₓ⌉-𝑥	#T97/A166.KorektoMath Reflection
𝓓ₓ⌉-𝑥 = 𝓓ₓ(⌉-𝑥)	#R98/M98.KorektoMath,T97 a → (a)
⌉-𝑥 = 𝖊∧-𝑥	#T99/A91.KorektoMath Exp
𝓓ₓ⌉-𝑥 = 𝓓ₓ(𝖊∧-𝑥)	#C100/I212.KorektoMath,T99,R98 (a)=(b),(a)→(b)
𝓓ₓ(𝖊∧-𝑥) = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#T101/A241.KorektoMath D(e^x)=D(x)e^x
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#C102/I206.KorektoMath,T101,C100 a=b,_a$→_b$
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)*𝖊∧-𝑥	#R103/M163.KorektoMath,C102 Explicit*
𝓓ₓ(-𝑥) = -1	#R104/M244.KorektoMath,S82.KorektoMath 𝓓ₓ-𝑥=-1
𝓓ₓ⌉-𝑥 = -1*𝖊∧-𝑥	#C105/I197.KorektoMath,R104,R103 a=b,a→b
𝓓ₓ⌉-𝑥 = -𝖊∧-𝑥	#R106/M178.KorektoMath,C105 1*
𝓓ₓ⌉-𝑥 = -(𝖊∧-𝑥)	#R107/M160.KorektoMath,R106 a^b → (a^b)
-𝓓ₓ⌉-𝑥 = (𝖊∧-𝑥)	#R108/M227.KorektoMath,R107 a=-b;-a=-b
# Substituting
𝓓ₓ⌈𝑥 = (𝖊∧-𝑥) / (1+⌉-𝑥)²	#C109/I197.KorektoMath,R108,C96 a=b,a→b
𝓓ₓ⌈𝑥 = 𝖊∧-𝑥 / (1+⌉-𝑥)²	#R110/M136.KorektoMath,C109 ♭(g)♭ → _g_
𝓓ₓ⌈𝑥 = ⌉-𝑥 / (1+⌉-𝑥)²	#C111/I205.KorektoMath,T99,R110 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥)²	#R112/M113.KorektoMath,C111 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) 1/(1+⌉-𝑥)	#R113/M194.KorektoMath,R112 _a/b²$→_a/b_1/b$
⌈𝑥 = 1 / (1+⌉-𝑥)	#R114/M104.KorektoMath,R60 (a_+_b) → (a+b)
⌈𝑥 = 1/(1+⌉-𝑥)	#R115/M113.KorektoMath,R114 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) ⌈𝑥	#C116/I207.KorektoMath,R115,R113 a=b,_b$→_a$
...
𝓓ₓ⌈𝑥 = ⌈-𝑥 ⌈𝑥	#C120/I205.KorektoMath,R119,C116 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = 1-⌈𝑥 ⌈𝑥	#C121/I204.KorektoMath,R82,C120 a=b,_a_→_b_
𝓓ₓ⌈𝑥 = (1-⌈𝑥) ⌈𝑥	#R122/M110.KorektoMath,C121 _a+b_ → ♭(a♭+♭b)♭
𝓓ₓ⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#R123/M163.KorektoMath,R122 Explicit*
𝓑⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#T124/A232.KorektoMath Binary balance
...
#   Math.log(𝑥 / (1 - 𝑥))
# Here  its:
⌋𝑥 = ⌊ 𝑥/(1-𝑥)	#T126/A231.KorektoMath Unsquash
# Show that unsquash is the inverse of squash(⌋⌈=1):
⌋⌈𝑥 = ⌋⌈𝑥	#T127/A166.KorektoMath Reflection
⌋⌈𝑥 = ⌊ ⌈𝑥/(1-⌈𝑥)	#T128/A231.KorektoMath Unsquash
⌊ ⌈𝑥/(1-⌈𝑥) = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#T129/A229.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#C130/I216.KorektoMath,T129,T128 a=b, +_a$ → +_b$
⌋⌈𝑥 = ⌊(⌈𝑥) - ⌊(1-⌈𝑥)	#R131/M98.KorektoMath,C130 a → (a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R69/M106.KorektoMath,R68 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = ⌊(⌉𝑥 / 1+⌉𝑥) - ⌊(1-⌈𝑥)	#C132/I212.KorektoMath,R69,R131 (a)=(b),(a)→(b)
⌋⌈𝑥 = ⌊ ⌉𝑥/(1+⌉𝑥) - ⌊(1-⌈𝑥)	#R133/M124.KorektoMath,C132 ♭(a_*_g)♭ → _a*(g)_
⌊ ⌉𝑥/(1+⌉𝑥) = ⌊⌉𝑥 - ⌊(1+⌉𝑥)	#T134/A229.KorektoMath ⌊(a/b)=⌊a-⌊b
⌊⌉𝑥 = 𝑥	#R52/M99.KorektoMath,R51 (a) → a
⌊ ⌉𝑥/(1+⌉𝑥) = 𝑥 - ⌊(1+⌉𝑥)	#C135/I197.KorektoMath,R52,T134 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊(1-⌈𝑥)	#C136/I218.KorektoMath,C135,R133 a=b, +_a_+ → +_b_+
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-⌈𝑥	#R137/M106.KorektoMath,C136 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌈𝑥)	#R138/M98.KorektoMath,R137 a → (a)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌉𝑥 / 1+⌉𝑥)	#C139/I212.KorektoMath,R69,R138 (a)=(b),(a)→(b)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R140/M193.KorektoMath,C139 _1±(a_/_b) → (b±a / b)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1 / 1+⌉𝑥)	#R141/M185.KorektoMath,R140 +a-a_
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1/(1+⌉𝑥)	#R142/M126.KorektoMath,R141 ♭(a_*_g)$ → _a*(g)$
⌊ 1/(1+⌉𝑥) = ⌊1 - ⌊(1+⌉𝑥)	#T143/A229.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊1 - ⌊(1+⌉𝑥)	#C144/I216.KorektoMath,T143,R142 a=b, +_a$ → +_b$
⌊1 = 0	#C58/I206.KorektoMath,R57,T55 a=b,_a$→_b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - 0 - ⌊(1+⌉𝑥)	#C145/I197.KorektoMath,C58,C144 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) + ⌊(1+⌉𝑥)	#R146/M186.KorektoMath,C145 ±0± → +
⌋⌈𝑥 = 𝑥	#R147/M184.KorektoMath,R146 -a+a$ → $
...
ᵢ⭎ = ⁱ	#C10/I12.KorektoMath,S5,S4 →2nd
∑ᵢ(𝑾ₕᵢ𝒂ᵢ) = 𝑾ₕⁱ𝒂ᵢ	#R152/M245.KorektoMath,C10 Einstein notation
𝒂ₕ = ⌈ 𝒃ₕ+(𝑾ₕⁱ𝒂ᵢ)	#C153/I208.KorektoMath,R152,R151 a=(b),a→(b)
