...
𝖊𝓵(𝖊∧𝑥) = 𝑥	#C17/I241.KorektoMath,S14,R16 G=F,(F)→(G)
...
⌉0 = 𝖊∧(𝑥 - 𝑥)	#C25/I241.KorektoMath,T24,R23 G=F,(F)→(G)
⌉0 = 𝖊∧(𝑥 + -𝑥)	#R26/M249.KorektoMath,C25 a-b=a+-b
⌉0 = 𝖊∧𝑥*𝖊∧-𝑥	#R27/M253.KorektoMath,R26 a^(b+c)=a^b*a^c
⌉0 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R28/M174.KorektoMath,R27 a^b~c^d → (a^b)~(c^c)
# Then:
𝖊∧-𝑥 = 1 / 𝖊∧𝑥	#T29/A39.KorektoMath Reciprical
⌉0 = (𝖊∧𝑥)*(1 / 𝖊∧𝑥)	#C30/I240.KorektoMath,T29,R28 G=F,(G)→(F)
⌉0 = (𝖊∧𝑥)*(1 / (𝖊∧𝑥))	#R31/M154.KorektoMath,C30 _g)→_(g))
⌉0 = ((𝖊∧𝑥) / (𝖊∧𝑥))	#R32/M203.KorektoMath,R31 x*(1/y) → (x/y)
...
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉-𝑥)	#C37/I240.KorektoMath,T21,R36 G=F,(G)→(F)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉(-𝑥))	#R38/M104.KorektoMath,C37 a → (a)
⌉(-𝑥) = 𝖊∧(-𝑥)	#T39/A97.KorektoMath Exp
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧(-𝑥))	#C40/I240.KorektoMath,T39,R38 G=F,(G)→(F)
...
⌊(⌉(𝑥)) = 𝑥	#C50/I241.KorektoMath,T49,C48 G=F,(F)→(G)
...
⌊1 = 0	#C58/I231.KorektoMath,R57,T55 g=f,_g$→_f$
```
### Squash
```korekto
...
⌈𝑥 = ⌉𝑥 / (⌉𝑥*1 + ⌉𝑥*⌉-𝑥)	#R63/M218.KorektoMath,R62 (x*a♭±♭x*b)
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥*⌉-𝑥)	#R64/M185.KorektoMath,R63 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥⌉-𝑥)	#R65/M176.KorektoMath,R64 Implied*
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + 1)	#C66/I226.KorektoMath,C43,R65 g=a,_g)→_a)
⌈𝑥 = ⌉𝑥 / (1 + ⌉𝑥)	#R67/M254.KorektoMath,C66 (a+b)→(b+a)
...
1-⌈𝑥 = 1 - (⌉𝑥 / 1+⌉𝑥)	#C72/I235.KorektoMath,R68,R71 a=G,a→(G)
1-⌈𝑥 = (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R73/M205.KorektoMath,C72 _1±(a_/_g) → (g±a / g)
1-⌈𝑥 = 1+⌉𝑥-⌉𝑥 / 1+⌉𝑥	#R74/M160.KorektoMath,R73 +_(G)$ → +_G$
1-⌈𝑥 = 1 / 1+⌉𝑥	#R75/M192.KorektoMath,R74 +a-a_
# Consider ⌈0
⌈0 = ⌈0	#T76/A178.KorektoMath Reflection
⌈0 = ⌉0 / 1+⌉0	#T77/A69 Alternate Squash
⌉0 = 𝖊∧0	#T22/A97.KorektoMath Exp
𝖊∧0 = 1	#T56/A38.KorektoMath x∧0=1
⌉0 = 1	#C78/I231.KorektoMath,T56,T22 g=f,_g$→_f$
⌈0 = 1 / 1+1	#C79/I223.KorektoMath,C78,T77 a=b,2*a→b
...
⌈0 = 1 / 2	#C85/I232.KorektoMath,R84,C79 g=f,_f$→_g$
⌈0 = 1/2	#R86/M119.KorektoMath,C85 _a_*_b$ → _a*b$
½ : 1/2	#S209.KorektoMath/L1.KorektoMath ≝: ½
...
⌉1 = 𝖊	#C92/I231.KorektoMath,T91,T90 g=f,_g$→_f$
