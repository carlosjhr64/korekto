...
𝖊𝓵(𝖊∧𝑥) = 𝑥	#C16/I209.KorektoMath,S13,R15 (a)=(b),(b)→(a)
...
⌉0 = 𝖊∧(𝑥 - 𝑥)	#C24/I209.KorektoMath,T23,R22 (a)=(b),(b)→(a)
⌉0 = 𝖊∧(𝑥 + -𝑥)	#R25/M217.KorektoMath,C24 a-b=a+-b
⌉0 = 𝖊∧𝑥*𝖊∧-𝑥	#R26/M220.KorektoMath,R25 a^(b+c)=a^b*a^c
⌉0 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R27/M162.KorektoMath,R26 a^b~c^d → (a^b)~(c^c)
# Then:
𝖊∧-𝑥 = 1 / 𝖊∧𝑥	#T28/A36.KorektoMath Reciprical
⌉0 = (𝖊∧𝑥)*(1 / 𝖊∧𝑥)	#C29/I208.KorektoMath,T28,R27 (a)=(b),(a)→(b)
⌉0 = (𝖊∧𝑥)*(1 / (𝖊∧𝑥))	#R30/M142.KorektoMath,C29 _g)→_(g))
⌉0 = ((𝖊∧𝑥) / (𝖊∧𝑥))	#R31/M187.KorektoMath,R30 x*(1/y) → (x/y)
⌉0 = (1)	#R32/M171.KorektoMath,R31 (a/a)→(1)
⌉0 = 1	#R33/M99.KorektoMath,R32 (a) → a
# Prove ⌉𝑥⌉-𝑥 = 1
⌉𝑥⌉-𝑥 = ⌉𝑥⌉-𝑥	#T34/A166.KorektoMath Reflection
⌉𝑥⌉-𝑥 = ⌉𝑥*⌉-𝑥	#R35/M163.KorektoMath,T34 Explicit*
⌉𝑥⌉-𝑥 = (⌉𝑥)*(⌉-𝑥)	#R36/M100.KorektoMath,R35 a~b → (a)~(b)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉-𝑥)	#C37/I208.KorektoMath,T20,R36 (a)=(b),(a)→(b)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉(-𝑥))	#R38/M98.KorektoMath,C37 a → (a)
⌉(-𝑥) = 𝖊∧(-𝑥)	#T39/A91.KorektoMath Exp
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧(-𝑥))	#C40/I208.KorektoMath,T39,R38 (a)=(b),(a)→(b)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R41/M99.KorektoMath,C40 (a) → a
⌉𝑥⌉-𝑥 = ⌉0	#C42/I169.KorektoMath,R41,R27 a=b;c=b;a=c
⌉𝑥⌉-𝑥 = 1	#C43/I167.KorektoMath,C42,R33 a=b;b=c;a=c
# Abstract
⌉𝓍⌉-𝓍 = 1	#A44/C43 ⌉𝑥⌉-𝑥=1
⌉-𝓍⌉𝓍 = 1	#A45 ⌉-𝑥⌉𝑥=1
```
...
⌊(𝖊∧(𝑥)) = 𝑥	#C48/I167.KorektoMath,T47,R17 a=b;b=c;a=c
⌉(𝑥) = 𝖊∧(𝑥)	#T49/A91.KorektoMath Exp
⌊(⌉(𝑥)) = 𝑥	#C50/I209.KorektoMath,T49,C48 (a)=(b),(b)→(a)
...
⌊1 = 0	#C58/I202.KorektoMath,R57,T55 a=b,_a$→_b$
```
### Squash
```korekto
...
#     1 / (1 + Math.exp(-𝑥))
# Here its:
⌈𝑥 = 1 / 1+⌉-𝑥	#T59/A226.KorektoMath Squash
⌈𝑥 = 1 / (1 + ⌉-𝑥)	#R60/M107.KorektoMath,T59 _a+b$ → ♭(a♭+♭b)$
# Alternate
⌈𝑥 = (1) / (1 + ⌉-𝑥)	#R61/M98.KorektoMath,R60 a → (a)
⌈𝑥 = ⌉𝑥*(1) / ⌉𝑥*(1 + ⌉-𝑥)	#R62/M184.KorektoMath,R61 _x*a_/_x*b$
⌈𝑥 = ⌉𝑥 / ⌉𝑥*(1 + ⌉-𝑥)	#R63/M175.KorektoMath,R62 *(1)_
⌈𝑥 = ⌉𝑥 / (⌉𝑥*1 + ⌉𝑥*⌉-𝑥)	#R64/M191.KorektoMath,R63 (x*a♭±♭x*b)
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥*⌉-𝑥)	#R65/M173.KorektoMath,R64 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥⌉-𝑥)	#R66/M164.KorektoMath,R65 Implied*
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + 1)	#C67/I197.KorektoMath,C43,R66 g=a,_g)→_a)
⌈𝑥 = ⌉𝑥 / (1 + ⌉𝑥)	#R68/M221.KorektoMath,C67 (a+b)→(b+a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R69/M106.KorektoMath,R68 ♭(a♭+♭b)$ → _a+b$
⌈𝓍 = ⌉𝓍 / 1+⌉𝓍	#A70/R69 Alternate Squash
# Equivalence 1-⌈𝑥 = ⌈-𝑥
1-⌈𝑥 = 1-⌈𝑥	#T71/A166.KorektoMath Reflection
1-⌈𝑥 = 1 - ⌈𝑥	#R72/M156.KorektoMath,T71 +_g+f$ → +_g_+_f$
1-⌈𝑥 = 1 - (⌉𝑥 / 1+⌉𝑥)	#C73/I204.KorektoMath,R69,R72 a=(b),a→(b)
1-⌈𝑥 = (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R74/M189.KorektoMath,C73 _1±(a_/_b) → (b±a / b)
1-⌈𝑥 = 1+⌉𝑥-⌉𝑥 / 1+⌉𝑥	#R75/M148.KorektoMath,R74 +_(G)$ → +_G$
1-⌈𝑥 = 1 / 1+⌉𝑥	#R76/M181.KorektoMath,R75 +a-a_
# Cosider ⌈-𝑥
⌈-𝑥 = ⌈-𝑥	#T77/A166.KorektoMath Reflection
⌈-𝑥 = 1 / 1+⌉--𝑥	#T78/A226.KorektoMath Squash
⌈-𝑥 = 1 / 1+⌉𝑥	#R79/M222.KorektoMath,T78 --a→a
# Then:
1-⌈𝑥 = ⌈-𝑥	#C80/I170.KorektoMath,R79,R76 a=b;c=b;c=a
1-⌈𝓍 = ⌈-𝓍	#A81/C80 1-⌈𝑥=⌈-𝑥
⌈-𝑥 = 1-⌈𝑥	#R82/M165.KorektoMath,C80 Symmetry
⌈-𝓍 = 1-⌈𝓍	#A83/R82 ⌈-𝑥=1-⌈𝑥
# Corrolary: ⌈𝑥+⌈-𝑥 = 1
⌈𝑥+⌈-𝑥 = ⌈𝑥+⌈-𝑥	#T84/A166.KorektoMath Reflection
⌈𝑥+⌈-𝑥 = ⌈𝑥 + ⌈-𝑥	#R85/M156.KorektoMath,T84 +_g+f$ → +_g_+_f$
⌈𝑥+⌈-𝑥 = ⌈𝑥 + 1-⌈𝑥	#C86/I202.KorektoMath,R82,R85 a=b,_a$→_b$
⌈𝑥+⌈-𝑥 = ⌈𝑥 + 1 - ⌈𝑥	#R87/M156.KorektoMath,C86 +_g+f$ → +_g_+_f$
⌈𝑥+⌈-𝑥 = (⌈𝑥 + 1) - ⌈𝑥	#R88/M145.KorektoMath,R87 +_G_+ → +_(G)_+
⌈𝑥+⌈-𝑥 = (1 + ⌈𝑥) - ⌈𝑥	#R89/M221.KorektoMath,R88 (a+b)→(b+a)
⌈𝑥+⌈-𝑥 = 1 + ⌈𝑥 - ⌈𝑥	#R90/M144.KorektoMath,R89 +_(G)_+ → +_G_+
⌈𝑥+⌈-𝑥 = 1	#R91/M179.KorektoMath,R90 +a-a$ → $
# Derivative:
# Label 𝑥
ₓ → 𝑥	#S82.KorektoMath/L74.KorektoMath Map: ₓ
# ₓ → 𝑥;𝓓ₓ𝓐(𝑥) = ...
𝓓ₓ⌈𝑥 = 𝓓ₓ⌈𝑥	#T92/A166.KorektoMath Reflection
𝓓ₓ⌈𝑥 = 𝓓ₓ(⌈𝑥)	#R93/M98.KorektoMath,T92 a → (a)
𝓓ₓ⌈𝑥 = 𝓓ₓ(1 / 1+⌉-𝑥)	#C94/I208.KorektoMath,T59,R93 (a)=(b),(a)→(b)
𝓓ₓ(1 / 1+⌉-𝑥) = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#T95/A234.KorektoMath From quotient rule
𝓓ₓ⌈𝑥 = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#C96/I212.KorektoMath,T95,C94 a=b, +_a$ → +_b$
# Consider 𝓓ₓ⌉-𝑥
𝓓ₓ⌉-𝑥 = 𝓓ₓ⌉-𝑥	#T97/A166.KorektoMath Reflection
𝓓ₓ⌉-𝑥 = 𝓓ₓ(⌉-𝑥)	#R98/M98.KorektoMath,T97 a → (a)
⌉-𝑥 = 𝖊∧-𝑥	#T99/A91.KorektoMath Exp
𝓓ₓ⌉-𝑥 = 𝓓ₓ(𝖊∧-𝑥)	#C100/I208.KorektoMath,T99,R98 (a)=(b),(a)→(b)
𝓓ₓ(𝖊∧-𝑥) = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#T101/A237.KorektoMath D(e^x)=D(x)e^x
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#C102/I202.KorektoMath,T101,C100 a=b,_a$→_b$
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)*𝖊∧-𝑥	#R103/M163.KorektoMath,C102 Explicit*
𝓓ₓ(-𝑥) = -1	#R104/M240.KorektoMath,S82.KorektoMath 𝓓ₓ-𝑥=-1
𝓓ₓ⌉-𝑥 = -1*𝖊∧-𝑥	#C105/I193.KorektoMath,R104,R103 a=b,a→b
𝓓ₓ⌉-𝑥 = -𝖊∧-𝑥	#R106/M174.KorektoMath,C105 _1*
𝓓ₓ⌉-𝑥 = -(𝖊∧-𝑥)	#R107/M160.KorektoMath,R106 a^b → (a^b)
-𝓓ₓ⌉-𝑥 = (𝖊∧-𝑥)	#R108/M223.KorektoMath,R107 a=-b;-a=-b
# Substituting
𝓓ₓ⌈𝑥 = (𝖊∧-𝑥) / (1+⌉-𝑥)²	#C109/I193.KorektoMath,R108,C96 a=b,a→b
𝓓ₓ⌈𝑥 = 𝖊∧-𝑥 / (1+⌉-𝑥)²	#R110/M136.KorektoMath,C109 ♭(g)♭ → _g_
𝓓ₓ⌈𝑥 = ⌉-𝑥 / (1+⌉-𝑥)²	#C111/I201.KorektoMath,T99,R110 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥)²	#R112/M113.KorektoMath,C111 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) 1/(1+⌉-𝑥)	#R113/M190.KorektoMath,R112 _a/b²$→_a/b_1/b$
⌈𝑥 = 1 / (1+⌉-𝑥)	#R114/M104.KorektoMath,R60 (a_+_b) → (a+b)
⌈𝑥 = 1/(1+⌉-𝑥)	#R115/M113.KorektoMath,R114 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) ⌈𝑥	#C116/I203.KorektoMath,R115,R113 a=b,_b$→_a$
...
𝓓ₓ⌈𝑥 = ⌈-𝑥 ⌈𝑥	#C120/I201.KorektoMath,R119,C116 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = 1-⌈𝑥 ⌈𝑥	#C121/I200.KorektoMath,R82,C120 a=b,_a_→_b_
𝓓ₓ⌈𝑥 = (1-⌈𝑥) ⌈𝑥	#R122/M110.KorektoMath,C121 _a+b_ → ♭(a♭+♭b)♭
𝓓ₓ⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#R123/M163.KorektoMath,R122 Explicit*
𝓑⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#T124/A228.KorektoMath Binary balance
𝓓ₓ⌈𝑥 = 𝓑⌈𝑥	#C125/I170.KorektoMath,T124,R123 a=b;c=b;c=a
```
### Unsquash
```korekto
...
#   Math.log(𝑥 / (1 - 𝑥))
# Here  its:
⌋𝑥 = ⌊ 𝑥/(1-𝑥)	#T126/A227.KorektoMath Unsquash
# Show that unsquash is the inverse of squash(⌋⌈=1):
⌋⌈𝑥 = ⌋⌈𝑥	#T127/A166.KorektoMath Reflection
⌋⌈𝑥 = ⌊ ⌈𝑥/(1-⌈𝑥)	#T128/A227.KorektoMath Unsquash
⌊ ⌈𝑥/(1-⌈𝑥) = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#T129/A225.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#C130/I212.KorektoMath,T129,T128 a=b, +_a$ → +_b$
⌋⌈𝑥 = ⌊(⌈𝑥) - ⌊(1-⌈𝑥)	#R131/M98.KorektoMath,C130 a → (a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R69/M106.KorektoMath,R68 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = ⌊(⌉𝑥 / 1+⌉𝑥) - ⌊(1-⌈𝑥)	#C132/I208.KorektoMath,R69,R131 (a)=(b),(a)→(b)
⌋⌈𝑥 = ⌊ ⌉𝑥/(1+⌉𝑥) - ⌊(1-⌈𝑥)	#R133/M124.KorektoMath,C132 ♭(a_*_g)♭ → _a*(g)_
⌊ ⌉𝑥/(1+⌉𝑥) = ⌊⌉𝑥 - ⌊(1+⌉𝑥)	#T134/A225.KorektoMath ⌊(a/b)=⌊a-⌊b
⌊⌉𝑥 = 𝑥	#R52/M99.KorektoMath,R51 (a) → a
⌊ ⌉𝑥/(1+⌉𝑥) = 𝑥 - ⌊(1+⌉𝑥)	#C135/I193.KorektoMath,R52,T134 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊(1-⌈𝑥)	#C136/I214.KorektoMath,C135,R133 a=b, +_a_+ → +_b_+
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-⌈𝑥	#R137/M106.KorektoMath,C136 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌈𝑥)	#R138/M98.KorektoMath,R137 a → (a)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌉𝑥 / 1+⌉𝑥)	#C139/I208.KorektoMath,R69,R138 (a)=(b),(a)→(b)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R140/M189.KorektoMath,C139 _1±(a_/_b) → (b±a / b)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1 / 1+⌉𝑥)	#R141/M181.KorektoMath,R140 +a-a_
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1/(1+⌉𝑥)	#R142/M126.KorektoMath,R141 ♭(a_*_g)$ → _a*(g)$
⌊ 1/(1+⌉𝑥) = ⌊1 - ⌊(1+⌉𝑥)	#T143/A225.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊1 - ⌊(1+⌉𝑥)	#C144/I212.KorektoMath,T143,R142 a=b, +_a$ → +_b$
⌊1 = 0	#C58/I202.KorektoMath,R57,T55 a=b,_a$→_b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - 0 - ⌊(1+⌉𝑥)	#C145/I193.KorektoMath,C58,C144 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) + ⌊(1+⌉𝑥)	#R146/M182.KorektoMath,C145 ±0± → +
⌋⌈𝑥 = 𝑥	#R147/M180.KorektoMath,R146 -a+a$ → $
...
ᵢ⭎ = ⁱ	#C10/I12.KorektoMath,S5,S4 →2nd
∑ᵢ(𝑾ₕᵢ𝒂ᵢ) = 𝑾ₕⁱ𝒂ᵢ	#R152/M241.KorektoMath,C10 Einstein notation
𝒂ₕ = ⌈ 𝒃ₕ+(𝑾ₕⁱ𝒂ᵢ)	#C153/I204.KorektoMath,R152,R151 a=(b),a→(b)
𝒂ₕ = ⌈ 𝒃ₕ+𝑾ₕⁱ𝒂ᵢ	#R154/M132.KorektoMath,C153 *(ab)$ → *ab$
...
⌋𝒂 = ⌋⌈ 𝒃+𝑾𝒂₊	#R156/M224.KorektoMath,H155 x_=_G_g;Fx_=_FG_g
⌋⌈(𝒃+𝑾𝒂₊) = (𝒃+𝑾𝒂₊)	#T157/A148 Inverse
⌋⌈(𝒃+𝑾𝒂₊) = 𝒃+𝑾𝒂₊	#R158/M138.KorektoMath,T157 ♭(g)$ → _g$
⌋⌈ 𝒃+𝑾𝒂₊ = 𝒃+𝑾𝒂₊	#R159/M136.KorektoMath,R158 ♭(g)♭ → _g_
⌋𝒂 = 𝒃+𝑾𝒂₊	#C160/I212.KorektoMath,R159,R156 a=b, +_a$ → +_b$
# Neuron's value
𝒗 : ⌋𝒂	#S161/L1.KorektoMath ≝: 𝒗
# Shrunk 𝒗
ₕ⭎ = ʰ	#C9/I11.KorektoMath,S5,S4 →1st
ᵢ⭎ = ⁱ	#C10/I12.KorektoMath,S5,S4 →2nd
𝒗 = 𝒃+𝑾𝒂₊	#C162/I167.KorektoMath,S161,C160 a=b;b=c;a=c
# Explicit 𝒗
𝒗ₕ = 𝒃ₕ+𝑾ʰⁱ𝒂ᵢ	#H163
! stop!
```
