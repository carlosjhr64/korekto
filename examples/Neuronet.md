...
𝖊𝓵(𝖊∧𝑥) = 𝑥	#C16/I207.KorektoMath,S13,R15 (a)=(b),(b)→(a)
...
⌉0 = 𝖊∧(𝑥 - 𝑥)	#C24/I207.KorektoMath,T23,R22 (a)=(b),(b)→(a)
⌉0 = 𝖊∧(𝑥 + -𝑥)	#R25/M215.KorektoMath,C24 a-b=a+-b
⌉0 = 𝖊∧𝑥*𝖊∧-𝑥	#R26/M218.KorektoMath,R25 a^(b+c)=a^b*a^c
⌉0 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R27/M162.KorektoMath,R26 a^b~c^d → (a^b)~(c^c)
# Then:
𝖊∧-𝑥 = 1 / 𝖊∧𝑥	#T28/A36.KorektoMath Reciprical
⌉0 = (𝖊∧𝑥)*(1 / 𝖊∧𝑥)	#C29/I206.KorektoMath,T28,R27 (a)=(b),(a)→(b)
⌉0 = (𝖊∧𝑥)*(1 / (𝖊∧𝑥))	#R30/M142.KorektoMath,C29 _g)→_(g))
⌉0 = ((𝖊∧𝑥) / (𝖊∧𝑥))	#R31/M185.KorektoMath,R30 x*(1/y) → (x/y)
...
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉-𝑥)	#C36/I206.KorektoMath,T20,R35 (a)=(b),(a)→(b)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉(-𝑥))	#R37/M98.KorektoMath,C36 a → (a)
⌉(-𝑥) = 𝖊∧(-𝑥)	#T38/A91.KorektoMath Exp
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧(-𝑥))	#C39/I206.KorektoMath,T38,R37 (a)=(b),(a)→(b)
...
⌊(⌉(𝑥)) = 𝑥	#C49/I207.KorektoMath,T48,C47 (a)=(b),(b)→(a)
...
⌊1 = 0	#C57/I200.KorektoMath,R56,T54 a=b,_a$→_b$
```
### Squash
```korekto
...
#     1 / (1 + Math.exp(-𝑥))
# Here its:
⌈𝑥 = 1 / 1+⌉-𝑥	#T58/A224.KorektoMath Squash
⌈𝑥 = 1 / (1 + ⌉-𝑥)	#R59/M107.KorektoMath,T58 _a+b$ → ♭(a♭+♭b)$
# Alternate
⌈𝑥 = ⌉𝑥*1 / ⌉𝑥*(1 + ⌉-𝑥)	#R60/M182.KorektoMath,R59 _x*a_/_x*b$
⌈𝑥 = ⌉𝑥 / ⌉𝑥*(1 + ⌉-𝑥)	#R61/M173.KorektoMath,R60 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥*1 + ⌉𝑥*⌉-𝑥)	#R62/M189.KorektoMath,R61 (x*a♭±♭x*b)
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥*⌉-𝑥)	#R63/M173.KorektoMath,R62 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥⌉-𝑥)	#R64/M164.KorektoMath,R63 Implied*
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + 1)	#C65/I195.KorektoMath,C42,R64 g=a,_g)→_a)
⌈𝑥 = ⌉𝑥 / (1 + ⌉𝑥)	#R66/M219.KorektoMath,C65 (a+b)→(b+a)
...
1-⌈𝑥 = 1 - (⌉𝑥 / 1+⌉𝑥)	#C71/I202.KorektoMath,R67,R70 a=(b),a→(b)
1-⌈𝑥 = (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R72/M187.KorektoMath,C71 _1±(a_/_b) → (b±a / b)
1-⌈𝑥 = 1+⌉𝑥-⌉𝑥 / 1+⌉𝑥	#R73/M148.KorektoMath,R72 +_(G)$ → +_G$
1-⌈𝑥 = 1 / 1+⌉𝑥	#R74/M179.KorektoMath,R73 +a-a_
# Cosider ⌈-𝑥
⌈-𝑥 = ⌈-𝑥	#T75/A166.KorektoMath Reflection
⌈-𝑥 = 1 / 1+⌉--𝑥	#T76/A224.KorektoMath Squash
⌈-𝑥 = 1 / 1+⌉𝑥	#R77/M220.KorektoMath,T76 --a→a
# Then:
...
𝓓ₓ⌈𝑥 = 𝓓ₓ(1 / 1+⌉-𝑥)	#C92/I206.KorektoMath,T58,R91 (a)=(b),(a)→(b)
𝓓ₓ(1 / 1+⌉-𝑥) = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#T93/A232.KorektoMath From quotient rule
𝓓ₓ⌈𝑥 = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#C94/I210.KorektoMath,T93,C92 a=b, +_a$ → +_b$
# Consider 𝓓ₓ⌉-𝑥
𝓓ₓ⌉-𝑥 = 𝓓ₓ⌉-𝑥	#T95/A166.KorektoMath Reflection
𝓓ₓ⌉-𝑥 = 𝓓ₓ(⌉-𝑥)	#R96/M98.KorektoMath,T95 a → (a)
⌉-𝑥 = 𝖊∧-𝑥	#T97/A91.KorektoMath Exp
𝓓ₓ⌉-𝑥 = 𝓓ₓ(𝖊∧-𝑥)	#C98/I206.KorektoMath,T97,R96 (a)=(b),(a)→(b)
𝓓ₓ(𝖊∧-𝑥) = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#T99/A235.KorektoMath D(e^x)=D(x)e^x
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#C100/I200.KorektoMath,T99,C98 a=b,_a$→_b$
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)*𝖊∧-𝑥	#R101/M163.KorektoMath,C100 Explicit*
𝓓ₓ(-𝑥) = -1	#R102/M238.KorektoMath,S82.KorektoMath 𝓓ₓ-𝑥=-1
𝓓ₓ⌉-𝑥 = -1*𝖊∧-𝑥	#C103/I191.KorektoMath,R102,R101 a=b,a→b
𝓓ₓ⌉-𝑥 = -𝖊∧-𝑥	#R104/M174.KorektoMath,C103 _1*
𝓓ₓ⌉-𝑥 = -(𝖊∧-𝑥)	#R105/M160.KorektoMath,R104 a^b → (a^b)
-𝓓ₓ⌉-𝑥 = (𝖊∧-𝑥)	#R106/M221.KorektoMath,R105 a=-b;-a=-b
# Substituting
𝓓ₓ⌈𝑥 = (𝖊∧-𝑥) / (1+⌉-𝑥)²	#C107/I191.KorektoMath,R106,C94 a=b,a→b
𝓓ₓ⌈𝑥 = 𝖊∧-𝑥 / (1+⌉-𝑥)²	#R108/M136.KorektoMath,C107 ♭(g)♭ → _g_
𝓓ₓ⌈𝑥 = ⌉-𝑥 / (1+⌉-𝑥)²	#C109/I199.KorektoMath,T97,R108 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥)²	#R110/M113.KorektoMath,C109 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) 1/(1+⌉-𝑥)	#R111/M188.KorektoMath,R110 _a/b²$→_a/b_1/b$
⌈𝑥 = 1 / (1+⌉-𝑥)	#R112/M104.KorektoMath,R59 (a_+_b) → (a+b)
⌈𝑥 = 1/(1+⌉-𝑥)	#R113/M113.KorektoMath,R112 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) ⌈𝑥	#C114/I201.KorektoMath,R113,R111 a=b,_b$→_a$
...
𝓓ₓ⌈𝑥 = ⌈-𝑥 ⌈𝑥	#C118/I199.KorektoMath,R117,C114 a=b,_b_→_a_
𝓓ₓ⌈𝑥 = 1-⌈𝑥 ⌈𝑥	#C119/I198.KorektoMath,R80,C118 a=b,_a_→_b_
𝓓ₓ⌈𝑥 = (1-⌈𝑥) ⌈𝑥	#R120/M110.KorektoMath,C119 _a+b_ → ♭(a♭+♭b)♭
𝓓ₓ⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#R121/M163.KorektoMath,R120 Explicit*
𝓑⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#T122/A226.KorektoMath Binary balance
...
#   Math.log(𝑥 / (1 - 𝑥))
# Here  its:
⌋𝑥 = ⌊ 𝑥/(1-𝑥)	#T124/A225.KorektoMath Unsquash
# Show that unsquash is the inverse of squash(⌋⌈=1):
⌋⌈𝑥 = ⌋⌈𝑥	#T125/A166.KorektoMath Reflection
⌋⌈𝑥 = ⌊ ⌈𝑥/(1-⌈𝑥)	#T126/A225.KorektoMath Unsquash
⌊ ⌈𝑥/(1-⌈𝑥) = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#T127/A223.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#C128/I210.KorektoMath,T127,T126 a=b, +_a$ → +_b$
⌋⌈𝑥 = ⌊(⌈𝑥) - ⌊(1-⌈𝑥)	#R129/M98.KorektoMath,C128 a → (a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R67/M106.KorektoMath,R66 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = ⌊(⌉𝑥 / 1+⌉𝑥) - ⌊(1-⌈𝑥)	#C130/I206.KorektoMath,R67,R129 (a)=(b),(a)→(b)
⌋⌈𝑥 = ⌊ ⌉𝑥/(1+⌉𝑥) - ⌊(1-⌈𝑥)	#R131/M124.KorektoMath,C130 ♭(a_*_g)♭ → _a*(g)_
⌊ ⌉𝑥/(1+⌉𝑥) = ⌊⌉𝑥 - ⌊(1+⌉𝑥)	#T132/A223.KorektoMath ⌊(a/b)=⌊a-⌊b
⌊⌉𝑥 = 𝑥	#R51/M99.KorektoMath,R50 (a) → a
⌊ ⌉𝑥/(1+⌉𝑥) = 𝑥 - ⌊(1+⌉𝑥)	#C133/I191.KorektoMath,R51,T132 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊(1-⌈𝑥)	#C134/I212.KorektoMath,C133,R131 a=b, +_a_+ → +_b_+
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-⌈𝑥	#R135/M106.KorektoMath,C134 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌈𝑥)	#R136/M98.KorektoMath,R135 a → (a)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌉𝑥 / 1+⌉𝑥)	#C137/I206.KorektoMath,R67,R136 (a)=(b),(a)→(b)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R138/M187.KorektoMath,C137 _1±(a_/_b) → (b±a / b)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1 / 1+⌉𝑥)	#R139/M179.KorektoMath,R138 +a-a_
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1/(1+⌉𝑥)	#R140/M126.KorektoMath,R139 ♭(a_*_g)$ → _a*(g)$
⌊ 1/(1+⌉𝑥) = ⌊1 - ⌊(1+⌉𝑥)	#T141/A223.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊1 - ⌊(1+⌉𝑥)	#C142/I210.KorektoMath,T141,R140 a=b, +_a$ → +_b$
⌊1 = 0	#C57/I200.KorektoMath,R56,T54 a=b,_a$→_b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - 0 - ⌊(1+⌉𝑥)	#C143/I191.KorektoMath,C57,C142 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) + ⌊(1+⌉𝑥)	#R144/M180.KorektoMath,C143 ±0± → +
⌋⌈𝑥 = 𝑥	#R145/M178.KorektoMath,R144 -a+a$ → $
...
ᵢ⭎ = ⁱ	#C10/I12.KorektoMath,S5,S4 →2nd
∑ᵢ(𝑾ₕᵢ𝒂ᵢ) = 𝑾ₕⁱ𝒂ᵢ	#R150/M239.KorektoMath,C10 Einstein notation
𝒂ₕ = ⌈ 𝒃ₕ+(𝑾ₕⁱ𝒂ᵢ)	#C151/I202.KorektoMath,R150,R149 a=(b),a→(b)
