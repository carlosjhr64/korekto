...
𝖊𝓵(𝖊∧𝑥) = 𝑥	#C17/I229.KorektoMath,S14,R16 G=F,(F)→(G)
...
⌉0 = 𝖊∧(𝑥 - 𝑥)	#C25/I229.KorektoMath,T24,R23 G=F,(F)→(G)
⌉0 = 𝖊∧(𝑥 + -𝑥)	#R26/M237.KorektoMath,C25 a-b=a+-b
⌉0 = 𝖊∧𝑥*𝖊∧-𝑥	#R27/M240.KorektoMath,R26 a^(b+c)=a^b*a^c
⌉0 = (𝖊∧𝑥)*(𝖊∧-𝑥)	#R28/M169.KorektoMath,R27 a^b~c^d → (a^b)~(c^c)
# Then:
𝖊∧-𝑥 = 1 / 𝖊∧𝑥	#T29/A40.KorektoMath Reciprical
⌉0 = (𝖊∧𝑥)*(1 / 𝖊∧𝑥)	#C30/I228.KorektoMath,T29,R28 G=F,(G)→(F)
...
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉-𝑥)	#C37/I228.KorektoMath,T21,R36 G=F,(G)→(F)
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(⌉(-𝑥))	#R38/M105.KorektoMath,C37 a → (a)
⌉(-𝑥) = 𝖊∧(-𝑥)	#T39/A98.KorektoMath Exp
⌉𝑥⌉-𝑥 = (𝖊∧𝑥)*(𝖊∧(-𝑥))	#C40/I228.KorektoMath,T39,R38 G=F,(G)→(F)
...
⌊(⌉(𝑥)) = 𝑥	#C50/I229.KorektoMath,T49,C48 G=F,(F)→(G)
...
⌊1 = 0	#C58/I219.KorektoMath,R57,T55 g=f,_g$→_f$
```
### Squash
```korekto
...
#     1 / (1 + Math.exp(-𝑥))
# Here its:
⌈𝑥 = 1 / 1+⌉-𝑥	#T59/A249.KorektoMath Squash
...
⌈𝑥 = ⌉𝑥 / (⌉𝑥*1 + ⌉𝑥*⌉-𝑥)	#R63/M208.KorektoMath,R62 (x*a♭±♭x*b)
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥*⌉-𝑥)	#R64/M180.KorektoMath,R63 *1_
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + ⌉𝑥⌉-𝑥)	#R65/M171.KorektoMath,R64 Implied*
⌈𝑥 = ⌉𝑥 / (⌉𝑥 + 1)	#C66/I214.KorektoMath,C43,R65 g=a,_g)→_a)
⌈𝑥 = ⌉𝑥 / (1 + ⌉𝑥)	#R67/M241.KorektoMath,C66 (a+b)→(b+a)
...
1-⌈𝑥 = 1 - (⌉𝑥 / 1+⌉𝑥)	#C72/I223.KorektoMath,R68,R71 a=G,a→(G)
...
# Consider ⌈0
⌈0 = ⌈0	#T76/A173.KorektoMath Reflection
⌈0 = ⌉0 / 1+⌉0	#T77/A69 Alternate Squash
⌉0 = 𝖊∧0	#T22/A98.KorektoMath Exp
𝖊∧0 = 1	#T56/A39.KorektoMath x∧0=1
⌉0 = 1	#C78/I219.KorektoMath,T56,T22 g=f,_g$→_f$
⌈0 = 1 / 1+1	#C79/I211.KorektoMath,C78,T77 a=b,2*a→b
1 + 1 : 2	#S49.KorektoMath/L1.KorektoMath ≝: 2
1 + 1 = 2	#R80/M2.KorektoMath,S49.KorektoMath ≝→=
2 = 1 + 1	#R81/M172.KorektoMath,R80 Symmetry
2 = (1 + 1)	#R82/M156.KorektoMath,R81 +_G$ → +_(G)$
2 = (1+1)	#R83/M111.KorektoMath,R82 (a_+_b) → (a+b)
2 = 1+1	#R84/M113.KorektoMath,R83 ♭(a♭+♭b)$ → _a+b$
⌈0 = 1 / 2	#C85/I220.KorektoMath,R84,C79 g=f,_f$→_g$
⌈0 = 1/2	#R86/M120.KorektoMath,C85 _a_*_b$ → _a*b$
½ : 1/2	#S204.KorektoMath/L1.KorektoMath ≝: ½
⌈0 = ½	#C87/I177.KorektoMath,S204.KorektoMath,R86 a=b;c=b;c=a
# Consider ⌈1
⌈1 = ⌈1	#T88/A173.KorektoMath Reflection
⌈1 = ⌉1 / 1+⌉1	#T89/A69 Alternate Squash
⌉1 = 𝖊∧1	#T90/A98.KorektoMath Exp
𝖊∧1 = 𝖊	#T91/A38.KorektoMath x∧1=x
⌉1 = 𝖊	#C92/I219.KorektoMath,T91,T90 g=f,_g$→_f$
⌈1 = 𝖊 / 1+𝖊	#C93/I211.KorektoMath,C92,T89 a=b,2*a→b
# Consider ⌈-𝑥
⌈-𝑥 = ⌈-𝑥	#T94/A173.KorektoMath Reflection
⌈-𝑥 = 1 / 1+⌉--𝑥	#T95/A249.KorektoMath Squash
⌈-𝑥 = 1 / 1+⌉𝑥	#R96/M242.KorektoMath,T95 --a→a
# Then:
1-⌈𝑥 = ⌈-𝑥	#C97/I177.KorektoMath,R96,R75 a=b;c=b;c=a
1-⌈𝓍 = ⌈-𝓍	#A98/C97 1-⌈𝑥=⌈-𝑥
⌈-𝑥 = 1-⌈𝑥	#R99/M172.KorektoMath,C97 Symmetry
⌈-𝓍 = 1-⌈𝓍	#A100/R99 ⌈-𝑥=1-⌈𝑥
# Corrolary: ⌈𝑥+⌈-𝑥 = 1
⌈𝑥+⌈-𝑥 = ⌈𝑥+⌈-𝑥	#T101/A173.KorektoMath Reflection
⌈𝑥+⌈-𝑥 = ⌈𝑥 + ⌈-𝑥	#R102/M163.KorektoMath,T101 +_g+f$ → +_g_+_f$
⌈𝑥+⌈-𝑥 = ⌈𝑥 + 1-⌈𝑥	#C103/I219.KorektoMath,R99,R102 g=f,_g$→_f$
⌈𝑥+⌈-𝑥 = ⌈𝑥 + 1 - ⌈𝑥	#R104/M163.KorektoMath,C103 +_g+f$ → +_g_+_f$
⌈𝑥+⌈-𝑥 = (⌈𝑥 + 1) - ⌈𝑥	#R105/M152.KorektoMath,R104 +_G_+ → +_(G)_+
⌈𝑥+⌈-𝑥 = (1 + ⌈𝑥) - ⌈𝑥	#R106/M241.KorektoMath,R105 (a+b)→(b+a)
⌈𝑥+⌈-𝑥 = 1 + ⌈𝑥 - ⌈𝑥	#R107/M151.KorektoMath,R106 +_(G)_+ → +_G_+
⌈𝑥+⌈-𝑥 = 1	#R108/M185.KorektoMath,R107 +a-a$ → $
# Derivative:
# Label 𝑥
ₓ → 𝑥	#S109/L22.KorektoMath Replace: ₓ
# ₓ → 𝑥;𝓓ₓ𝓐(𝑥) = ...
𝓓ₓ⌈𝑥 = 𝓓ₓ⌈𝑥	#T110/A173.KorektoMath Reflection
𝓓ₓ⌈𝑥 = 𝓓ₓ(⌈𝑥)	#R111/M105.KorektoMath,T110 a → (a)
𝓓ₓ⌈𝑥 = 𝓓ₓ(1 / 1+⌉-𝑥)	#C112/I228.KorektoMath,T59,R111 G=F,(G)→(F)
𝓓ₓ(1 / 1+⌉-𝑥) = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#T113/A257.KorektoMath From quotient rule
𝓓ₓ⌈𝑥 = -𝓓ₓ⌉-𝑥 / (1+⌉-𝑥)²	#C114/I232.KorektoMath,T113,C112 G=F, +_G$ → +_F$
# Consider 𝓓ₓ⌉-𝑥
𝓓ₓ⌉-𝑥 = 𝓓ₓ⌉-𝑥	#T115/A173.KorektoMath Reflection
𝓓ₓ⌉-𝑥 = 𝓓ₓ(⌉-𝑥)	#R116/M105.KorektoMath,T115 a → (a)
⌉-𝑥 = 𝖊∧-𝑥	#T117/A98.KorektoMath Exp
𝓓ₓ⌉-𝑥 = 𝓓ₓ(𝖊∧-𝑥)	#C118/I228.KorektoMath,T117,R116 G=F,(G)→(F)
𝓓ₓ(𝖊∧-𝑥) = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#T119/A259.KorektoMath D(e^x)=D(x)e^x
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)𝖊∧-𝑥	#C120/I219.KorektoMath,T119,C118 g=f,_g$→_f$
𝓓ₓ⌉-𝑥 = 𝓓ₓ(-𝑥)*𝖊∧-𝑥	#R121/M170.KorektoMath,C120 Explicit*
𝓓ₓ(-𝑥) = -1	#R122/M262.KorektoMath,S109 𝓓ₓ-𝑥=-1
𝓓ₓ⌉-𝑥 = -1*𝖊∧-𝑥	#C123/I210.KorektoMath,R122,R121 a=b,a→b
𝓓ₓ⌉-𝑥 = -𝖊∧-𝑥	#R124/M181.KorektoMath,C123 _1*
𝓓ₓ⌉-𝑥 = -(𝖊∧-𝑥)	#R125/M167.KorektoMath,R124 a^b → (a^b)
-𝓓ₓ⌉-𝑥 = (𝖊∧-𝑥)	#R126/M243.KorektoMath,R125 a=-b;-a=-b
# Substituting
𝓓ₓ⌈𝑥 = (𝖊∧-𝑥) / (1+⌉-𝑥)²	#C127/I210.KorektoMath,R126,C114 a=b,a→b
𝓓ₓ⌈𝑥 = 𝖊∧-𝑥 / (1+⌉-𝑥)²	#R128/M143.KorektoMath,C127 ♭(g)♭ → _g_
𝓓ₓ⌈𝑥 = ⌉-𝑥 / (1+⌉-𝑥)²	#C129/I218.KorektoMath,T117,R128 g=f,_f_→_g_
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥)²	#R130/M120.KorektoMath,C129 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) 1/(1+⌉-𝑥)	#R131/M201.KorektoMath,R130 _a/b²$→_a/b_1/b$
⌈𝑥 = 1 / (1 + ⌉-𝑥)	#R60/M114.KorektoMath,T59 _a+b$ → ♭(a♭+♭b)$
⌈𝑥 = 1 / (1+⌉-𝑥)	#R132/M111.KorektoMath,R60 (a_+_b) → (a+b)
⌈𝑥 = 1/(1+⌉-𝑥)	#R133/M120.KorektoMath,R132 _a_*_b$ → _a*b$
𝓓ₓ⌈𝑥 = ⌉-𝑥/(1+⌉-𝑥) ⌈𝑥	#C134/I220.KorektoMath,R133,R131 g=f,_f$→_g$
...
𝓓ₓ⌈𝑥 = ⌈-𝑥 ⌈𝑥	#C138/I218.KorektoMath,R137,C134 g=f,_f_→_g_
𝓓ₓ⌈𝑥 = 1-⌈𝑥 ⌈𝑥	#C139/I217.KorektoMath,R99,C138 g=f,_g_→_f_
𝓓ₓ⌈𝑥 = (1-⌈𝑥) ⌈𝑥	#R140/M117.KorektoMath,C139 _a+b_ → ♭(a♭+♭b)♭
𝓓ₓ⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#R141/M170.KorektoMath,R140 Explicit*
𝓑⌈𝑥 = (1-⌈𝑥)*⌈𝑥	#T142/A251.KorektoMath Binary balance
𝓓ₓ⌈𝑥 = 𝓑⌈𝑥	#C143/I177.KorektoMath,T142,R141 a=b;c=b;c=a
```
### Unsquash
```korekto
...
#   Math.log(𝑥 / (1 - 𝑥))
# Here  its:
⌋𝑥 = ⌊ 𝑥/(1-𝑥)	#T144/A250.KorektoMath Unsquash
# Show that unsquash is the inverse of squash(⌋⌈=1):
⌋⌈𝑥 = ⌋⌈𝑥	#T145/A173.KorektoMath Reflection
⌋⌈𝑥 = ⌊ ⌈𝑥/(1-⌈𝑥)	#T146/A250.KorektoMath Unsquash
⌊ ⌈𝑥/(1-⌈𝑥) = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#T147/A248.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = ⌊⌈𝑥 - ⌊(1-⌈𝑥)	#C148/I232.KorektoMath,T147,T146 G=F, +_G$ → +_F$
⌋⌈𝑥 = ⌊(⌈𝑥) - ⌊(1-⌈𝑥)	#R149/M105.KorektoMath,C148 a → (a)
⌈𝑥 = ⌉𝑥 / 1+⌉𝑥	#R68/M113.KorektoMath,R67 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = ⌊(⌉𝑥 / 1+⌉𝑥) - ⌊(1-⌈𝑥)	#C150/I228.KorektoMath,R68,R149 G=F,(G)→(F)
⌋⌈𝑥 = ⌊ ⌉𝑥/(1+⌉𝑥) - ⌊(1-⌈𝑥)	#R151/M131.KorektoMath,C150 ♭(a_*_g)♭ → _a*(g)_
⌊ ⌉𝑥/(1+⌉𝑥) = ⌊⌉𝑥 - ⌊(1+⌉𝑥)	#T152/A248.KorektoMath ⌊(a/b)=⌊a-⌊b
⌊⌉𝑥 = 𝑥	#R52/M106.KorektoMath,R51 (a) → a
⌊ ⌉𝑥/(1+⌉𝑥) = 𝑥 - ⌊(1+⌉𝑥)	#C153/I210.KorektoMath,R52,T152 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊(1-⌈𝑥)	#C154/I234.KorektoMath,C153,R151 G=F, +_G_+ → +_F_+
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-⌈𝑥	#R155/M113.KorektoMath,C154 ♭(a♭+♭b)$ → _a+b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌈𝑥)	#R156/M105.KorektoMath,R155 a → (a)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1-(⌉𝑥 / 1+⌉𝑥)	#C157/I228.KorektoMath,R68,R156 G=F,(G)→(F)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1+⌉𝑥-⌉𝑥 / 1+⌉𝑥)	#R158/M200.KorektoMath,C157 _1±(a_/_g) → (g±a / g)
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ (1 / 1+⌉𝑥)	#R159/M187.KorektoMath,R158 +a-a_
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊ 1/(1+⌉𝑥)	#R160/M133.KorektoMath,R159 ♭(a_*_g)$ → _a*(g)$
⌊ 1/(1+⌉𝑥) = ⌊1 - ⌊(1+⌉𝑥)	#T161/A248.KorektoMath ⌊(a/b)=⌊a-⌊b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - ⌊1 - ⌊(1+⌉𝑥)	#C162/I232.KorektoMath,T161,R160 G=F, +_G$ → +_F$
⌊1 = 0	#C58/I219.KorektoMath,R57,T55 a=b,_a$→_b$
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) - 0 - ⌊(1+⌉𝑥)	#C163/I210.KorektoMath,C58,C162 a=b,a→b
⌋⌈𝑥 = 𝑥 - ⌊(1+⌉𝑥) + ⌊(1+⌉𝑥)	#R164/M191.KorektoMath,C163 ±0± → +
⌋⌈𝑥 = 𝑥	#R165/M186.KorektoMath,R164 -a+a$ → $
...
ₛ → ˢ	#C11/I13.KorektoMath,S5,S6 2nd
∑ₛ(𝑾ᵣₛ𝒂ₛ) = 𝑾ᵣˢ𝒂ₛ	#R170/M263.KorektoMath,C11 Einstein notation
𝒂ᵣ = ⌈ 𝒃ᵣ+(𝑾ᵣˢ𝒂ₛ)	#C171/I223.KorektoMath,R170,R169 a=G,a→(G)
𝒂ᵣ = ⌈ 𝒃ᵣ+𝑾ᵣˢ𝒂ₛ	#R172/M139.KorektoMath,C171 *(ab)$ → *ab$
...
⌋𝒂 = ⌋⌈ 𝒃+𝑾𝒂₊	#R174/M245.KorektoMath,H173 x_=_G_g;Fx_=_FG_g
⌋⌈(𝒃+𝑾𝒂₊) = (𝒃+𝑾𝒂₊)	#T175/A166 Inverse
⌋⌈(𝒃+𝑾𝒂₊) = 𝒃+𝑾𝒂₊	#R176/M145.KorektoMath,T175 ♭(g)$ → _g$
⌋⌈ 𝒃+𝑾𝒂₊ = 𝒃+𝑾𝒂₊	#R177/M143.KorektoMath,R176 ♭(g)♭ → _g_
⌋𝒂 = 𝒃+𝑾𝒂₊	#C178/I232.KorektoMath,R177,R174 G=F, +_G$ → +_F$
# Neuron's value
𝒗 : ⌋𝒂	#S179/L1.KorektoMath ≝: 𝒗
𝒗 = 𝒃+𝑾𝒂₊	#C180/I174.KorektoMath,S179,C178 a=b;b=c;a=c
# Explicit 𝒗
...
⌈0 = ½	#C87/I177.KorektoMath,S204.KorektoMath,R86 a=b;c=b;c=a
0 = 𝖇+𝖜*½	#C187/I210.KorektoMath,C87,H186 a=b,a→b
0 = 𝖇+½𝖜	#R188/M205.KorektoMath,C187 a*½→½a
-𝖇 = ½𝖜	#R189/M244.KorektoMath,R188 0=b+g→-b=g
𝖇 = -½𝖜	#R190/M247.KorektoMath,R189 -a=bc→a=-bc
-½𝖜 = 𝖇	#R191/M172.KorektoMath,R190 Symmetry
𝖜 = -2𝖇	#R192/M206.KorektoMath,R190 a=½b→b=2a
𝕧[1]	#R193/M6.KorektoMath,S182 Membership
𝕧 = 𝖇+𝖜*⌈𝕧	#R185/M2.KorektoMath,S183 ≝→=
1 = 𝖇+𝖜*⌈1	#H194 Case 1∊𝕧
1 = 𝖇 + 𝖜*⌈1	#R195/M163.KorektoMath,H194 +_g+f$ → +_g_+_f$
1 = -½𝖜 + 𝖜*⌈1	#C196/I218.KorektoMath,R191,R195 g=f,_f_→_g_
1 = -½𝖜 + 𝖜⌈1	#R197/M171.KorektoMath,C196 Implied*
1 = 𝖜⌈1 + -½𝖜	#W
1 = 𝖜⌈1 - ½𝖜	#W
1 = 𝖜(⌈1 - ½)	#W
𝖜 = 1/(⌈1 - ½)	#W
...
𝖇 = 1 / 1-2⌈1 #W
! stop!
𝕧[-1]	#R184/M6.KorektoMath,S177 Membership
𝕧 = 𝖇+𝖜*⌈𝕧	#R180/M2.KorektoMath,S178 ≝→=
-1 = 𝖇+𝖜*⌈-1	#H185 Case -1∊𝕧
-1 = 𝖇+𝖜*(1-⌈1)	#W
-1 = -½𝖜+𝖜*(1-⌈1)	#W
-1 = 𝖜*(-½+1-⌈1)	#W
-1 = 𝖜*(½-⌈1)	#W
